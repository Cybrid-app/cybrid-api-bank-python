...
**failure_code** | **str, none_type** | The failure code for failed trades; one of non_sufficient_funds, unsupported, limit_exceeded, expired_quote, market_volatility, not_filled, daily_limit_exceeded, weekly_limit_exceeded, monthly_limit_exceeded, or lifetime_limit_exceeded. | [optional] 
...
**fee** | **int** | The fee associated with the trade. Denominated in \&quot;counter_asset\&quot; base units. Represents the sum of the bank and platform fees. | [optional] 
**fee_details** | [**[FeeDetail]**](FeeDetail.md) | The fees associated with the trade. | [optional] 
