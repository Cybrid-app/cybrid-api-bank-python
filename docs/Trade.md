...
**failure_code** | **str, none_type** | The failure code for failed trades; one of non_sufficient_funds, unsupported, limit_exceeded, expired_quote, market_volatility, not_filled, daily_limit_exceeded, weekly_limit_exceeded, or monthly_limit_exceeded. | [optional] 
