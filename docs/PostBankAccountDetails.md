...
**account_designation** | **str, none_type** | Account designation for India IFSC accounts (NRE or NRO). Defaults to NRE when omitted. Optional when payment_rail is IFSC. | [optional] 
