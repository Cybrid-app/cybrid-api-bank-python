...
**product_type** | **str** | The type of product the quote is for; one of trading, trading_exit, funding, crypto_transfer, inter_account, lightning_transfer, or book_transfer. | [optional] 
