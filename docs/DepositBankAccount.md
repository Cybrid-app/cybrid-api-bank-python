...
**name** | **str, none_type** | The name of the deposit bank account. | [optional] 
...
**state** | **str** | The state of the deposit bank account; one of storing, created, deleting, or deleted. | [optional] 
**unique_memo_id** | **str** | The unique memo identifier for the deposit bank account. This is used to identify the recipient when sending funds to the account. This value MUST be included in all wire transfers to this account. | [optional] 
