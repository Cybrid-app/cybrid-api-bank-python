...
**state** | **str** | The state of the transfer; one of storing, pending, holding, reviewing, completed, or failed. | [optional] 
...
**fee_details** | [**[FeeDetail]**](FeeDetail.md) | The fees associated with the transfer. | [optional] 
...
**txn_hash** | **str, none_type** | The hash of the blockchain transaction (deprecated: use identifiers array) | [optional] 
**identifiers** | [**[TransferIdentifiersInner]**](TransferIdentifiersInner.md) | Array of identifiers associated with this transfer (transaction hash, wire reference numbers) | [optional] 
