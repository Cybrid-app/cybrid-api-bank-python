...
# **cancel_transfer**
> Transfer cancel_transfer(transfer_guid, accept_version)
...
with cybrid_api_bank.ApiClient(configuration) as api_client:
    ...
    accept_version = "Accept-Version_example" # str | API version; must be 2026-04-01 or later for this operation.

    # example passing only required values which don't have defaults set
    try:
        # Cancel Transfer
        api_response = api_instance.cancel_transfer(transfer_guid, accept_version)
        pprint(api_response)
    except cybrid_api_bank.ApiException as e:
        print("Exception when calling TransfersBankApi->cancel_transfer: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | Transfer cancellation initiated |  -  |
**401** | Unauthorized |  -  |
**403** | Forbidden |  -  |
**404** | Not Found |  -  |
