...
**redirect_uri** | **str** | The redirect URI for Plaid link. Optional when type is plaid. | [optional] 
**android_package_name** | **str** | The Android package name for Plaid link. Optional when type is plaid. | [optional] 
