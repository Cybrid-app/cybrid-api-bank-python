...
**identification_numbers** | [**[PostIdentificationNumber], none_type**](PostIdentificationNumber.md) | The customer&#39;s identification numbers. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_business_associate, type is kyc and method is attested_id_and_database, or type is kyc and method is attested_database. Optional when type is kyc and method is attested_id_and_selfie. | [optional] 
...
**business_industry** | **str, none_type** | The industry the business operates in. Required for attested business registration V3. Optional when type is kyc and method is attested_business_registration. | [optional] 
