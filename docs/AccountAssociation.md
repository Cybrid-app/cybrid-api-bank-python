...
**payment_rail** | **str, none_type** | The desired payment rail to use to initiate a fiat transfer. | [optional] 
**intermediate_requested** | **bool, none_type** | Whether this account was explicitly requested by the caller as an intermediate account. | [optional] 
