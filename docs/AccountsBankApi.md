...
with cybrid_api_bank.ApiClient(configuration) as api_client:
    ...
    include_balances = True # bool | Whether to include account balances in the response. (optional)
    ...
    try:
        # Get Account
        api_response = api_instance.get_account(account_guid, include_balances=include_balances)
        pprint(api_response)
    except cybrid_api_bank.ApiException as e:
        print("Exception when calling AccountsBankApi->get_account: %s\n" % e)
```
 ...
 **include_balances** | **bool**| Whether to include account balances in the response. | [optional]
...
with cybrid_api_bank.ApiClient(configuration) as api_client:
    ...
    try:
        # List Accounts
        api_response = api_instance.list_accounts(page=page, per_page=per_page, owner=owner, guid=guid, type=type, bank_guid=bank_guid, customer_guid=customer_guid, label=label, include_balances=include_balances)
        pprint(api_response)
    except cybrid_api_bank.ApiException as e:
...
# **update_account**
> Account update_account(account_guid, patch_account)
...
with cybrid_api_bank.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch Account
        api_response = api_instance.update_account(account_guid, patch_account)
        pprint(api_response)
    except cybrid_api_bank.ApiException as e:
        print("Exception when calling AccountsBankApi->update_account: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **account_guid** | **str**| Identifier for the account. |
 **patch_account** | [**PatchAccount**](PatchAccount.md)|  |
