...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://api-platform-bank.local.cybrid.com:3002" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://api-platform-bank.local.cybrid.com:3002",
                'description': "Local environment for internal development",
            },
            {
                'url': "https://bank.staging.cybrid.app",
                'description': "Staging environment is for internal use",
            },
            {
