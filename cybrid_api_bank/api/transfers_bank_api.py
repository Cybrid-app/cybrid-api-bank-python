...
class TransfersBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_transfer_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/transfers/{transfer_guid}',
        ...
        self.create_transfer_endpoint = _Endpoint(
            settings={
                'response_type': (Transfer,),
                'auth': [
                    'BearerAuth',
        ...
        self.get_transfer_endpoint = _Endpoint(
            settings={
                'response_type': (Transfer,),
                'auth': [
                    'BearerAuth',
        ...
        self.list_transfers_endpoint = _Endpoint(
            settings={
                'response_type': (TransferList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
        ...
        self.update_transfer_endpoint = _Endpoint(
            settings={
                'response_type': (Transfer,),
                'auth': [
                    'BearerAuth',
    ...
    def cancel_transfer(
        ...
        **kwargs
        ...
        Initiates cancellation of an eligible funding transfer.  Required scope: **transfers:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cancel_transfer(transfer_guid, accept_version, async_req=True)
        >>> result = thread.get()

        Args:
            transfer_guid (str): Identifier for the transfer.
            accept_version (str): API version; must be 2026-04-01 or later for this operation.
        ...
        kwargs['transfer_guid'] = \
            transfer_guid
        kwargs['accept_version'] = \
            accept_version
        return self.cancel_transfer_endpoint.call_with_http_info(**kwargs)
    ...
    def create_transfer(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['post_transfer'] = \
            post_transfer
        return self.create_transfer_endpoint.call_with_http_info(**kwargs)
    ...
    def get_transfer(
        ...
        **kwargs
        ...
        Retrieves a transfer.  Required scope: **transfers:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_transfer(transfer_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['transfer_guid'] = \
            transfer_guid
        return self.get_transfer_endpoint.call_with_http_info(**kwargs)

    def list_transfers(
        self,
        **kwargs
    ):
        """Get transfers list  # noqa: E501

        Retrieves a listing of transfers. Records are sorted by creation date in descending order.  Required scope: **transfers:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_transfers_endpoint.call_with_http_info(**kwargs)
    ...
    def update_transfer(
        ...
        **kwargs
        ...
        Update a transfer.  Required scope: **transfers:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_transfer(transfer_guid, patch_transfer, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['transfer_guid'] = \
            transfer_guid
        kwargs['patch_transfer'] = \
            patch_transfer
        return self.update_transfer_endpoint.call_with_http_info(**kwargs)
