...
class PersonaSessionsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_persona_session_endpoint = _Endpoint(
            settings={
                'response_type': (PersonaSession,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/persona_sessions',
                'operation_id': 'create_persona_session',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'post_persona_session',
                ],
                'required': [
                    'post_persona_session',
                ],
    ...
    def create_persona_session(
        ...
        **kwargs
        ...
        """Create Persona Session  # noqa: E501

        Create a Persona session.  Required scope: **persona_sessions:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_persona_session(post_persona_session, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_persona_session'] = \
            post_persona_session
        return self.create_persona_session_endpoint.call_with_http_info(**kwargs)
