...
class ExternalWalletsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.update_external_wallet_endpoint = _Endpoint(
            settings={
                'response_type': (ExternalWallet,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/external_wallets/{external_wallet_guid}',
                'operation_id': 'update_external_wallet',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def list_external_wallets(
        ...
        **kwargs
        ...
        Retrieves a listing of external wallets. Records are sorted by creation date in descending order.  Required scope: **external_wallets:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_external_wallet(
        ...
        **kwargs
        ...
        """Patch External Wallet  # noqa: E501

        Updates an external_wallet.  Required scope: **external_wallets:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_external_wallet(external_wallet_guid, patch_external_wallet, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['external_wallet_guid'] = \
            external_wallet_guid
        kwargs['patch_external_wallet'] = \
            patch_external_wallet
        return self.update_external_wallet_endpoint.call_with_http_info(**kwargs)
