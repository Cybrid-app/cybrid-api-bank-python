...
class ExternalBankAccountsBankApi(object):
    ...
    def get_external_bank_account(
        ...
        **kwargs
        ...
        Retrieves an external bank account.  Required scope: **external_bank_accounts:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_external_bank_accounts(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            state (str): Comma separated states to list external_bank_accounts for.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
