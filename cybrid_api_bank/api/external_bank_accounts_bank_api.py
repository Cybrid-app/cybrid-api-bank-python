...
class ExternalBankAccountsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_external_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (ExternalBankAccount,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/external_bank_accounts',
                'operation_id': 'create_external_bank_account',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'post_external_bank_account',
                ],
                'required': [
                    'post_external_bank_account',
                ],
        ...
        self.delete_external_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (ExternalBankAccount,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/external_bank_accounts/{external_bank_account_guid}',
                'operation_id': 'delete_external_bank_account',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_external_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (ExternalBankAccount,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/external_bank_accounts/{external_bank_account_guid}',
                'operation_id': 'get_external_bank_account',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_external_bank_accounts_endpoint = _Endpoint(
            settings={
                'response_type': (ExternalBankAccountList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/external_bank_accounts',
                'operation_id': 'list_external_bank_accounts',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_external_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (ExternalBankAccount,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/external_bank_accounts/{external_bank_account_guid}',
                'operation_id': 'patch_external_bank_account',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'external_bank_account_guid': 'path',
                    'patch_external_bank_account': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_external_bank_account(
        ...
        **kwargs
        ...
        Create an ExternalBankAccount.  ## Account creation  Accounts can be created for a Bank or a Customer.  To create accounts for your Bank, omit the `customer_guid` parameter in the request body. To create accounts for your Customers, include the `customer_guid` parameter in the request body.  ## State  | State | Description | |-------|-------------| | storing | The Platform is storing the external bank account details in our private store | | completed | The Platform has created the external bank account | | unverified | The external bank account is created, but it has not yet been verified | | failed | The Platform was not able to successfully create the external bank account | | refresh_required | The Platform has created the external bank account, but needs to be refreshed | | deleting | The Platform is deleting the external bank account | | deleted | The Platform has deleted the external bank account | | pending | The Platform is verifying that the account holder owns the external bank account | | reviewing | Ownership could not be confirmed automatically and the verification is under review | | expired | The ownership verification lapsed before it was completed, so the account was never verified |  ## Failure codes  | Code | Description | |------|-------------| | invalid_routing_number | The provided routing number is invalid | | invalid_account_number | The account number is invalid | | invalid_account_type | The account type is invalid | | duplicate | An account with the same details already exists | | plaid_processor_token | An account could not be created due to an invalid Plaid processor token or an error with Plaid | | plaid_multiple_accounts | The supplied Plaid token is associated with multiple accounts. Must only be a single account. | | create_failed | The bank account and associated holder could not be created correctly | | unverified_counterparty | The counterparty account is unverified | | legal_entity_incomplete_pii | The financial institution could not create the account because the information held for the account holder is insufficient. For a counterparty-owned account, re-create the counterparty with the required information; for a customer-owned or bank-owned account, contact Cybrid Support -- those records cannot be corrected through the API. | | missing_holder_info | The account holder's details could not be determined. On a `plaid` account the linked financial institution did not return an account holder name; re-link the account or create it with `account_kind: raw_routing_details`. On a `raw_routing_details` account, `counterparty_name` or `counterparty_address` was omitted; supply both and retry. | | ownership_mismatch | The account holder could not be shown to own the external bank account, either because the holder name did not match or because a reviewer denied the verification |  ## Sandbox simulation  On `2026-09-01`+, in sandbox only, `expected_behaviours` lets you deterministically drive the holder-name-match outcome instead of aligning your KYC/KYB data with Plaid's fixed sandbox identity: `passed_immediately` or `failed_immediately`. It is accepted and ignored on account kinds whose plan runs no holder-name match (for example, a bank-owned account). Outside of sandbox the parameter is rejected with a 400.  A simulated `passed_immediately` writes the same compliance decision a real pass would, and can move a customer to Tier Basic -- it is a stand-in for the check, not a bypass of its consequences.    Required scope: **external_bank_accounts:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_external_bank_account(post_external_bank_account, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_external_bank_account'] = \
            post_external_bank_account
        return self.create_external_bank_account_endpoint.call_with_http_info(**kwargs)

    def delete_external_bank_account(
        self,
        external_bank_account_guid,
        **kwargs
    ):
        ...
        Deletes an external bank account.  Required scope: **external_bank_accounts:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_external_bank_account(external_bank_account_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['external_bank_account_guid'] = \
            external_bank_account_guid
        return self.delete_external_bank_account_endpoint.call_with_http_info(**kwargs)
    ...
    def get_external_bank_account(
        ...
        **kwargs
        ...
        >>> thread = api.get_external_bank_account(external_bank_account_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['external_bank_account_guid'] = \
            external_bank_account_guid
        return self.get_external_bank_account_endpoint.call_with_http_info(**kwargs)

    def list_external_bank_accounts(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_external_bank_accounts(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_external_bank_accounts_endpoint.call_with_http_info(**kwargs)

    def patch_external_bank_account(
        self,
        external_bank_account_guid,
        patch_external_bank_account,
        **kwargs
        ...
        Patch an external bank account.  Required scope: **external_bank_accounts:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_external_bank_account(external_bank_account_guid, patch_external_bank_account, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['external_bank_account_guid'] = \
            external_bank_account_guid
        kwargs['patch_external_bank_account'] = \
            patch_external_bank_account
        return self.patch_external_bank_account_endpoint.call_with_http_info(**kwargs)
