...
class DepositBankAccountsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_deposit_bank_account_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/deposit_bank_accounts',
                'operation_id': 'create_deposit_bank_account',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'post_deposit_bank_account',
                ],
                'required': [
                    'post_deposit_bank_account',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'post_deposit_bank_account': 'body',
                },
        ...
        self.delete_deposit_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (DepositBankAccount,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/deposit_bank_accounts/{deposit_bank_account_guid}',
                'operation_id': 'delete_deposit_bank_account',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_deposit_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (DepositBankAccount,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/deposit_bank_accounts/{deposit_bank_account_guid}',
                'operation_id': 'get_deposit_bank_account',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_deposit_bank_accounts_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/deposit_bank_accounts',
                'operation_id': 'list_deposit_bank_accounts',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_deposit_bank_account_endpoint = _Endpoint(
            settings={
                'response_type': (DepositBankAccount,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/deposit_bank_accounts/{deposit_bank_account_guid}',
                'operation_id': 'update_deposit_bank_account',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'deposit_bank_account_guid': 'path',
                    'patch_deposit_bank_account': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_deposit_bank_account(
        ...
        **kwargs
        ...
        Creates a deposit bank account.  ## State  | State | Description | |-------|-------------| | storing | The Platform is storing the deposit bank account details in our private store | | created | The Platform has created the deposit bank account |    Required scope: **deposit_bank_accounts:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_deposit_bank_account(post_deposit_bank_account, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_deposit_bank_account'] = \
            post_deposit_bank_account
        return self.create_deposit_bank_account_endpoint.call_with_http_info(**kwargs)

    def delete_deposit_bank_account(
        self,
        deposit_bank_account_guid,
        **kwargs
    ):
        """Delete Deposit Bank Account  # noqa: E501

        Deletes a deposit bank account.  ## State  | State | Description | |-------|-------------| | deleting | The Platform is deleting the deposit bank account and closing the associated provider account | | deleted | The Platform has deleted the deposit bank account |    Required scope: **deposit_bank_accounts:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_deposit_bank_account(deposit_bank_account_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['deposit_bank_account_guid'] = \
            deposit_bank_account_guid
        return self.delete_deposit_bank_account_endpoint.call_with_http_info(**kwargs)
    ...
    def get_deposit_bank_account(
        ...
        **kwargs
        ...
        """Get Deposit Bank Account  # noqa: E501

        Retrieves a deposit bank account.  Required scope: **deposit_bank_accounts:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_deposit_bank_account(deposit_bank_account_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['deposit_bank_account_guid'] = \
            deposit_bank_account_guid
        return self.get_deposit_bank_account_endpoint.call_with_http_info(**kwargs)

    def list_deposit_bank_accounts(
        self,
        **kwargs
    ):
        """List Deposit Bank Accounts  # noqa: E501

        Retrieves a list of deposit bank accounts. Records are sorted by creation date in descending order.  Required scope: **deposit_bank_accounts:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_deposit_bank_accounts(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_deposit_bank_accounts_endpoint.call_with_http_info(**kwargs)

    def update_deposit_bank_account(
        self,
        deposit_bank_account_guid,
        patch_deposit_bank_account,
        **kwargs
    ):
        """Patch Deposit Bank Account  # noqa: E501

        Updates a deposit bank account.  Required scope: **deposit_bank_accounts:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_deposit_bank_account(deposit_bank_account_guid, patch_deposit_bank_account, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['deposit_bank_account_guid'] = \
            deposit_bank_account_guid
        kwargs['patch_deposit_bank_account'] = \
            patch_deposit_bank_account
        return self.update_deposit_bank_account_endpoint.call_with_http_info(**kwargs)
