...
class RewardsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_rewards_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/rewards',
                'operation_id': 'create_rewards',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_reward_endpoint = _Endpoint(
            settings={
                'response_type': (Reward,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/rewards/{reward_guid}',
                'operation_id': 'get_reward',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_rewards_endpoint = _Endpoint(
            settings={
                'response_type': (RewardList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
    ...
    def create_rewards(
        ...
        **kwargs
        ...
        Creates a reward.  Required scope: **rewards:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_rewards(post_reward, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_reward'] = \
            post_reward
        return self.create_rewards_endpoint.call_with_http_info(**kwargs)
    ...
    def get_reward(
        ...
        **kwargs
        ...
        Retrieves a reward.  Required scope: **rewards:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_reward(reward_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['reward_guid'] = \
            reward_guid
        return self.get_reward_endpoint.call_with_http_info(**kwargs)

    def list_rewards(
        self,
        **kwargs
    ):
        """Get rewards list  # noqa: E501

        Retrieves a listing of rewards.  Required scope: **rewards:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_rewards(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_rewards_endpoint.call_with_http_info(**kwargs)
