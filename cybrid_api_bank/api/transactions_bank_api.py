...
class TransactionsBankApi(object):
    ...
    def list_transactions(
        ...
        **kwargs
        ...
        Retrieves a listing of transactions (an account statement) for an account.  Required scope: **transactions:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_transactions(account_guid, async_req=True)
        >>> result = thread.get()
