...
class DepositAddressesBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.update_deposit_address_endpoint = _Endpoint(
            settings={
                'response_type': (DepositAddress,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/deposit_addresses/{deposit_address_guid}',
                'operation_id': 'update_deposit_address',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def list_deposit_addresses(
        ...
        **kwargs
        ...
        Retrieves a list of deposit addresses. Records are sorted by creation date in descending order.  Required scope: **deposit_addresses:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_deposit_address(
        ...
        **kwargs
        ...
        Updates a deposit address.  Required scope: **deposit_addresses:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_deposit_address(deposit_address_guid, patch_deposit_address, async_req=True)
        >>> result = thread.get()

        Args:
            deposit_address_guid (str): Identifier for the deposit address.
            patch_deposit_address (PatchDepositAddress):
        ...
        kwargs['deposit_address_guid'] = \
            deposit_address_guid
        kwargs['patch_deposit_address'] = \
            patch_deposit_address
        return self.update_deposit_address_endpoint.call_with_http_info(**kwargs)
