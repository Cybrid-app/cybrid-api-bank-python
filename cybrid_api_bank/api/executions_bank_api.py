...
class ExecutionsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_executions_endpoint = _Endpoint(
            settings={
    ...
    def list_executions(
        ...
        **kwargs
        ...
        """Get executions list  # noqa: E501

        Retrieves a listing of executions. Records are sorted by creation date in descending order.  Required scope: **executions:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_executions_endpoint.call_with_http_info(**kwargs)
