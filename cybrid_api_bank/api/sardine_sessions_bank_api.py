...
class SardineSessionsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sardine_session_endpoint = _Endpoint(
            settings={
                'response_type': (SardineSession,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/sardine_sessions',
                'operation_id': 'create_sardine_session',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'post_sardine_session',
                ],
                'required': [
                    'post_sardine_session',
                ],
    ...
    def create_sardine_session(
        self,
        post_sardine_session,
        **kwargs
    ):
        """Create Sardine Session  # noqa: E501

        Create a Sardine session.  Required scope: **sardine_sessions:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_sardine_session(post_sardine_session, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_sardine_session'] = \
            post_sardine_session
        return self.create_sardine_session_endpoint.call_with_http_info(**kwargs)
