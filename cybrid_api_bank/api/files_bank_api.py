...
class FilesBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_file_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/files/{file_guid}',
        ...
        self.list_files_endpoint = _Endpoint(
            settings={
                'response_type': (PlatformFileList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
    ...
    def get_file(
        ...
        **kwargs
        ...
        Retrieves a file.  Required scopes: **files:read,  files:pii:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_file(file_guid, async_req=True)
        >>> result = thread.get()
    ...
    def list_files(
        ...
        **kwargs
        ...
        Retrieves a list of files. Records are sorted by creation date in descending order.  Required scope: **files:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
