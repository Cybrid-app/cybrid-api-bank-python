...
class CounterpartiesBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_counterparty_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/counterparties',
        ...
        self.get_counterparty_endpoint = _Endpoint(
            settings={
                'response_type': (Counterparty,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/counterparties/{counterparty_guid}',
                'operation_id': 'get_counterparty',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_counterparties_endpoint = _Endpoint(
            settings={
                'response_type': (CounterpartyList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
    ...
    def get_counterparty(
        ...
        **kwargs
        ...
        """Get Counterparty  # noqa: E501

        Retrieves a counterparty.  Required scope: **counterparties:read** Optional scope: **counterparties:pii:read**.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_counterparty(counterparty_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['counterparty_guid'] = \
            counterparty_guid
        return self.get_counterparty_endpoint.call_with_http_info(**kwargs)

    def list_counterparties(
        self,
        **kwargs
    ):
        """Get counterparties list  # noqa: E501

        Retrieves a listing of counterparties. Records are sorted by creation date in descending order.  Required scope: **counterparties:read** Optional scope: **counterparties:pii:read**.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_counterparties_endpoint.call_with_http_info(**kwargs)
