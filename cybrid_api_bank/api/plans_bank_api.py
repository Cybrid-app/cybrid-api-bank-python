...
class PlansBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_plan_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/plans/{plan_guid}',
        ...
        self.list_plans_endpoint = _Endpoint(
            settings={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'type': 'query',
                    'state': 'query',
                    'source_account_guid': 'query',
                    'destination_account_guid': 'query',
    ...
    def get_plan(
        ...
        **kwargs
        ...
        Retrieves a plan.  Required scope: **plans:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_plan(plan_guid, async_req=True)
        >>> result = thread.get()
    ...
    def list_plans(
        ...
        **kwargs
        ...
        """Get plans list  # noqa: E501

        Retrieves a listing of plans. Records are sorted by creation date in descending order.  Required scope: **plans:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_plans_endpoint.call_with_http_info(**kwargs)
