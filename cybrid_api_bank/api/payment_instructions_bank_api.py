...
class PaymentInstructionsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_payment_instruction_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/payment_instructions',
                'operation_id': 'create_payment_instruction',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_payment_instruction_endpoint = _Endpoint(
            settings={
                'response_type': (PaymentInstruction,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/payment_instructions/{payment_instruction_guid}',
                'operation_id': 'get_payment_instruction',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'payment_instruction_guid': 'payment_instruction_guid',
                },
                'location_map': {
                    'payment_instruction_guid': 'path',
                },
                'collection_format_map': {
                }
            },
        ...
        self.list_payment_instructions_endpoint = _Endpoint(
            settings={
                'response_type': (PaymentInstructionList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/payment_instructions',
                'operation_id': 'list_payment_instructions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_payment_instruction(
        ...
        **kwargs
        ...
        """Create Payment Instruction  # noqa: E501

        Creates a payment instruction.  ## State  | State | Description | |-------|-------------| | storing | The Platform is storing the payment instruction details in our private store | | created | The Platform has created the payment instruction | | expired | The PaymentInstruction is no longer valid |    Required scope: **invoices:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_payment_instruction(post_payment_instruction, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_payment_instruction'] = \
            post_payment_instruction
        return self.create_payment_instruction_endpoint.call_with_http_info(**kwargs)
    ...
    def get_payment_instruction(
        ...
        **kwargs
        ...
        """Get Payment Instruction  # noqa: E501

        Retrieves a payment_instruction.  Required scope: **invoices:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_payment_instruction(payment_instruction_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['payment_instruction_guid'] = \
            payment_instruction_guid
        return self.get_payment_instruction_endpoint.call_with_http_info(**kwargs)

    def list_payment_instructions(
        self,
        **kwargs
    ):
        """List Payment Instructions  # noqa: E501

        Retrieves a list of payment instructions. Records are sorted by creation date in descending order.  Required scope: **invoices:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_payment_instructions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_payment_instructions_endpoint.call_with_http_info(**kwargs)
