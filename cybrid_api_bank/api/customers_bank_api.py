...
class CustomersBankApi(object):
    ...
    def get_customer(
        ...
        **kwargs
        ...
        Retrieves a customer.  Required scope: **customers:read** Optional scope: **customers:pii:read**.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_customers(
        ...
        **kwargs
        ...
        Retrieves a listing of customers. Records are sorted by creation date in descending order.  Required scope: **customers:read** Optional scope: **customers:pii:read**.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
