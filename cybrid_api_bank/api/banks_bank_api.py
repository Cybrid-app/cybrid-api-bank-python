...
class BanksBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_bank_endpoint = _Endpoint(
            settings={
                'response_type': (Bank,),
                'auth': [
                    'BearerAuth',
        ...
        self.get_bank_endpoint = _Endpoint(
            settings={
                'response_type': (Bank,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/banks/{bank_guid}',
        ...
        self.list_banks_endpoint = _Endpoint(
            settings={
                'response_type': (BankList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
        ...
        self.update_bank_endpoint = _Endpoint(
            settings={
                'response_type': (Bank,),
                'auth': [
                    'BearerAuth',
    ...
    def create_bank(
        ...
        **kwargs
        ...
        Creates a bank.  ## Bank Type  Bank's can be created in either `sandbox` or `production` mode. Sandbox Banks will not transact in real fiat dollars or cryptocurrencies.  Via the API, only `sandbox` banks can be created. In order to enable a `production` bank please contact [Support](mailto:support@cybrid.app).    Required scope: **banks:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_bank(post_bank, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_bank'] = \
            post_bank
        return self.create_bank_endpoint.call_with_http_info(**kwargs)
    ...
    def get_bank(
        ...
        **kwargs
        ...
        Retrieves a bank.  Required scope: **banks:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_bank(bank_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['bank_guid'] = \
            bank_guid
        return self.get_bank_endpoint.call_with_http_info(**kwargs)

    def list_banks(
        self,
        **kwargs
    ):
        """Get banks list  # noqa: E501

        Retrieves a listing of bank. Records are sorted by creation date in descending order.  Required scope: **banks:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_banks(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_banks_endpoint.call_with_http_info(**kwargs)
    ...
    def update_bank(
        ...
        **kwargs
        ...
        Update a bank.  Required scope: **banks:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_bank(bank_guid, patch_bank, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['patch_bank'] = \
            patch_bank
        return self.update_bank_endpoint.call_with_http_info(**kwargs)
