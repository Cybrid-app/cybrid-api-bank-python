...
class WorkflowsBankApi(object):
    ...
    def list_workflows(
        ...
        **kwargs
        ...
        Retrieves a listing of workflows. Records are sorted by creation date in descending order.  Required scope: **workflows:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
