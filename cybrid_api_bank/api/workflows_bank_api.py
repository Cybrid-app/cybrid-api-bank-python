...
class WorkflowsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_workflow_endpoint = _Endpoint(
            settings={
                'response_type': (WorkflowWithDetails,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/workflows/{workflow_guid}',
    ...
    def create_workflow(
        ...
        **kwargs
        ...
        Creates a workflow.  ## State  | State | Description | |-------|-------------| | storing | The Platform is storing the workflow details in our private store | | completed | The Platform has created the workflow | | failed | The workflow was not completed successfully |    Required scope: **workflows:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_workflow(post_workflow, async_req=True)
        >>> result = thread.get()
    ...
    def get_workflow(
        ...
        **kwargs
        ...
        Retrieves a workflow.  Required scope: **workflows:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_workflow(workflow_guid, async_req=True)
        >>> result = thread.get()
    ...
    def list_workflows(
        ...
        **kwargs
        ...
        """Get workflows list  # noqa: E501

        Retrieves a listing of workflows.  Required scope: **workflows:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
