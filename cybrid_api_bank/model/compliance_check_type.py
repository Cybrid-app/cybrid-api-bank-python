...
class ComplianceCheckType(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'BUSINESS_ATTESTED': "business_attested",
            'BUSINESS_TAX_ID_ATTESTED': "business_tax_id_attested",
            'BUSINESS_WATCHLISTS_ATTESTED': "business_watchlists_attested",
            'PERSON_ATTESTED': "person_attested",
            'PERSON_TAX_ID_ATTESTED': "person_tax_id_attested",
            'PERSON_GOV_ID_ATTESTED': "person_gov_id_attested",
            'PERSON_AUTHENTICATION_ATTESTED': "person_authentication_attested",
            'PERSON_WATCHLISTS_ATTESTED': "person_watchlists_attested",
            'PERSON_BANK_AUTHENTICATION': "person_bank_authentication",
            ...
            'BUSINESS_ASSOCIATE_GOV_ID_ATTESTED': "business_associate_gov_id_attested",
            'BUSINESS_ASSOCIATE_AUTHENTICATION_ATTESTED': "business_associate_authentication_attested",
            'BUSINESS_ASSOCIATE_ATTESTED': "business_associate_attested",
            'BUSINESS_ASSOCIATE_TAX_ID_ATTESTED': "business_associate_tax_id_attested",
            'BUSINESS_ASSOCIATE_WATCHLISTS_ATTESTED': "business_associate_watchlists_attested",
