...
class PostInternalFiatAssetConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, enabled, asset, *args, **kwargs):  # noqa: E501
        """PostInternalFiatAssetConfiguration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, enabled, asset, *args, **kwargs):  # noqa: E501
        """PostInternalFiatAssetConfiguration - a model defined in OpenAPI
