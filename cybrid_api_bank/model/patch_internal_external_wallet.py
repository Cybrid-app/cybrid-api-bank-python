...
class PatchInternalExternalWallet(ModelNormal):
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalExternalWallet - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_code (str, none_type): The failure code for failed external wallets.. [optional]  # noqa: E501
        """
