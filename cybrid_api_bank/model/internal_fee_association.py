...
class InternalFeeAssociation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, asset, quoted_amount, step_identifier, *args, **kwargs):  # noqa: E501
        """InternalFeeAssociation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, asset, quoted_amount, step_identifier, *args, **kwargs):  # noqa: E501
        """InternalFeeAssociation - a model defined in OpenAPI
