...
class VerificationCheck(ModelNormal):
    ...
    def _from_openapi_data(cls, type, state, *args, **kwargs):  # noqa: E501
        """VerificationCheck - a model defined in OpenAPI

        Args:
            type (str): The type of verification check; one of business_watchlists, business_verification, business_tax_id_verification, person_attested, person_tax_id_attested, person_watchlists, person_verification, person_authentication, person_gov_id_verification, or person_tax_id_verification.
