...
def lazy_import():
    ...
    globals()['InternalBankAccountService'] = InternalBankAccountService


class InternalBankAccountServiceList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalBankAccountService],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalBankAccountServiceList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalBankAccountService]): Array of entities
