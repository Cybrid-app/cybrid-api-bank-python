...
def lazy_import():
    ...
    globals()['InternalActivityLimitConfiguration'] = InternalActivityLimitConfiguration


class InternalActivityLimitConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalActivityLimitConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalActivityLimitConfigurationList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalActivityLimitConfiguration]): Array of entities
