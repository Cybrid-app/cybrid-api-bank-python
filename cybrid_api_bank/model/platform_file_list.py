...
class PlatformFileList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([PlatformFile],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """PlatformFileList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([PlatformFile]): Array of file entities
