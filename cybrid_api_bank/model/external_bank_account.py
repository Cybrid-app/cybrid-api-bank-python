...
def lazy_import():
    ...
    globals()['ExternalBankAccountBalances'] = ExternalBankAccountBalances
    globals()['ExternalBankAccountPiiInner'] = ExternalBankAccountPiiInner
...
class ExternalBankAccount(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'balance_updated_at': (datetime, none_type,),  # noqa: E501
            'balances': (ExternalBankAccountBalances,),  # noqa: E501
            'pii': ([ExternalBankAccountPiiInner], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'balance_updated_at': 'balance_updated_at',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            account_kind (str): The type of account; one of plaid, plaid_processor_token, or raw_routing_details.. [optional]  # noqa: E501
            environment (str): The environment that the external bank account is operating in; one of sandbox or production.. [optional]  # noqa: E501
            ...
            state (str): The state of the external bank account; one of storing, completed, failed, refresh_required, unverified, deleting, deleted, pending, reviewing, or expired.. [optional]  # noqa: E501
            failure_code (str, none_type): The failure code for the failed external bank account.. [optional]  # noqa: E501
            balance_updated_at (datetime, none_type): The timestamp that the balance information was last updated at.. [optional]  # noqa: E501
            balances (ExternalBankAccountBalances): [optional]  # noqa: E501
            pii ([ExternalBankAccountPiiInner], none_type): The account holder information.. [optional]  # noqa: E501
        """
