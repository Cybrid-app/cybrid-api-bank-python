...
class PostInvoice(ModelNormal):
    ...
    def _from_openapi_data(cls, asset, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            receive_amount (int): The amount to be received in base units of the asset, i.e., the amount the customer will receive after fees. ONLY one of receive_amount or deliver_amount is required.. [optional]  # noqa: E501
            deliver_amount (int): The amount to be delivered in base units of the asset, i.e., the amount the customer will receive before fees. ONLY one of receive_amount or deliver_amount is required.. [optional]  # noqa: E501
