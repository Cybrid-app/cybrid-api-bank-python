...
class PostInvoice(ModelNormal):
    ...
    def _from_openapi_data(cls, asset, *args, **kwargs):  # noqa: E501
        """PostInvoice - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            account_guid (str, none_type): The identifier for the account to use for the transfer. Required if the customer has multiple fiat accounts. Currently only valid for invoices paid to a fiat account.. [optional]  # noqa: E501
