...
class PostInternalExchangeSettlementPaymentOrder(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'exchange_settlement_guid': (str,),  # noqa: E501
            ...
            'expected_state': (str,),  # noqa: E501
            'network_fee_account_guid': (str, none_type,),  # noqa: E501
            'internal_network_fee_wallet_guid': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'expected_state': 'expected_state',  # noqa: E501
        'network_fee_account_guid': 'network_fee_account_guid',  # noqa: E501
        'internal_network_fee_wallet_guid': 'internal_network_fee_wallet_guid',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, exchange_settlement_guid, exchange_settlement_obligation_guid, sequence_number, payment_amount, internal_account_guid, internal_account_type, external_account_guid, external_account_type, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeSettlementPaymentOrder - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            network_fee (int, none_type): The network fee for the payment. Only required for crypto payments.. [optional]  # noqa: E501
            expected_state (str): The expected state of the underlying money transfer for the payment order (sandbox only). [optional]  # noqa: E501
            network_fee_account_guid (str, none_type): The identifier of the liability network fee account that has the network fee.. [optional]  # noqa: E501
            internal_network_fee_wallet_guid (str, none_type): The identifier of the cash network fee account that has the network fee.. [optional]  # noqa: E501
        """
        ...
        self.exchange_settlement_guid = exchange_settlement_guid
        self.exchange_settlement_obligation_guid = exchange_settlement_obligation_guid
        self.sequence_number = sequence_number
        self.payment_amount = payment_amount
        self.internal_account_guid = internal_account_guid
        self.internal_account_type = internal_account_type
        self.external_account_guid = external_account_guid
        self.external_account_type = external_account_type
    ...
    @convert_js_args_to_python_args
    def __init__(self, exchange_settlement_guid, exchange_settlement_obligation_guid, sequence_number, payment_amount, internal_account_guid, internal_account_type, external_account_guid, external_account_type, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeSettlementPaymentOrder - a model defined in OpenAPI
