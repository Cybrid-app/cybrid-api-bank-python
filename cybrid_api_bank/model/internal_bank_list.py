...
def lazy_import():
    ...
    globals()['InternalBank'] = InternalBank


class InternalBankList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalBank],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalBankList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalBank]): Array of internal bank entities
