...
class AccountType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["trading", "fee", "fiat", "gas", "reserve", "invoice_operations", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["trading", "fee", "fiat", "gas", "reserve", "invoice_operations", ]  # noqa: E501
