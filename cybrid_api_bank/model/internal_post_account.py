...
class InternalPostAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, asset, name, *args, **kwargs):  # noqa: E501
        """InternalPostAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): The account type.. defaults to "fee", must be one of ["fee", ]  # noqa: E501
            ...
            bank_guid (str, none_type): The bank identifier associated with the account.. [optional]  # noqa: E501
            labels ([str], none_type): The labels associated with the account.. [optional]  # noqa: E501
        """

        type = kwargs.get('type', "fee")
