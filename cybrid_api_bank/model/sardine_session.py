...
class SardineSession(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'guid': (str,),  # noqa: E501
            'sardine_session_key': (str,),  # noqa: E501
    ...
    attribute_map = {
        'guid': 'guid',  # noqa: E501
        'sardine_session_key': 'sardine_session_key',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, sardine_session_key, customer_guid, *args, **kwargs):  # noqa: E501
        """SardineSession - a model defined in OpenAPI

        Args:
            guid (str): Auto-generated unique identifier for the sardine session key.
            sardine_session_key (str): The session key to initialize the Sardine SDK with.
        ...
        Keyword Args:
            ...
            expires_at (datetime, none_type): The expiration datetime of the session key. Null if the session key does not expire.. [optional]  # noqa: E501
        """
        ...
        self.guid = guid
        self.sardine_session_key = sardine_session_key
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, sardine_session_key, customer_guid, *args, **kwargs):  # noqa: E501
        """SardineSession - a model defined in OpenAPI
