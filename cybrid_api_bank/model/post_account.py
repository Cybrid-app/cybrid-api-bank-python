...
class PostAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, customer_guid, asset, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            provider (str): The account provider, if applicable.. [optional] if omitted the server will use the default value of "compound"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, customer_guid, asset, name, *args, **kwargs):  # noqa: E501
        """PostAccount - a model defined in OpenAPI
