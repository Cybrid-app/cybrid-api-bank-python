...
class PostAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset, name, *args, **kwargs):  # noqa: E501
        """PostAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): The account type.. defaults to "trading", must be one of ["trading", ]  # noqa: E501
            ...
            customer_guid (str): The customer identifier associated with the account.. [optional]  # noqa: E501
        """

        type = kwargs.get('type', "trading")
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset, name, *args, **kwargs):  # noqa: E501
        """PostAccount - a model defined in OpenAPI
