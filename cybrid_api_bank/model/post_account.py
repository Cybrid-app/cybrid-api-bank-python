...
class PostAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, asset, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            customer_guid (str, none_type): TThe customer identifier associated with the account.. [optional]  # noqa: E501
            labels ([str], none_type): The labels associated with the account.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, asset, name, *args, **kwargs):  # noqa: E501
        """PostAccount - a model defined in OpenAPI
