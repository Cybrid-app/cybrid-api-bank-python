...
class InternalTransferList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalTransfer],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalTransferList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalTransfer]): Array of trade entities
