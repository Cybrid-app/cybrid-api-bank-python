...
class InternalFiatAssetConfiguration(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'maximum_number_of_accounts': (int, none_type,),  # noqa: E501
            'maximum_funding_quote_amount': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'asset': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'maximum_number_of_accounts': 'maximum_number_of_accounts',  # noqa: E501
        'maximum_funding_quote_amount': 'maximum_funding_quote_amount',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InternalFiatAssetConfiguration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): The type of fiat asset configuration: bank or platform.. [optional]  # noqa: E501
            ...
            enabled (bool): Flag indicating if the asset is enabled for fiat accounts on the platform.. [optional]  # noqa: E501
            invoices_enabled (bool): Flag indicating if the asset is enabled for invoices on the platform.. [optional]  # noqa: E501
            maximum_number_of_accounts (int, none_type): The maximum number of accounts allowed for the asset on the platform. Must be omitted or set to nil if enabled is False.. [optional]  # noqa: E501
            maximum_funding_quote_amount ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The maximum funding quote amounts by rail for the asset.. [optional]  # noqa: E501
