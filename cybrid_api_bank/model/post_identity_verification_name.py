...
class PostIdentityVerificationName(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            first (str, none_type): The customer's first name. Required when type is kyc and method is attested, type is kyc and method is attested_id_and_selfie, or type is kyc and method is attested_business_associate. Optional when type is bank_account and method is attested_ownership.. [optional]  # noqa: E501
            middle (str, none_type): The customer's middle name. Optional when type is kyc and method is attested, type is kyc and method is attested_id_and_selfie, type is kyc and method is attested_business_associate, or type is bank_account and method is attested_ownership.. [optional]  # noqa: E501
            last (str, none_type): The customer's last name. Required when type is kyc and method is attested, type is kyc and method is attested_id_and_selfie, or type is kyc and method is attested_business_associate. Optional when type is bank_account and method is attested_ownership.. [optional]  # noqa: E501
