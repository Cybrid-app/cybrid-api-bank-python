...
class AccountAssociation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'intermediate_requested': (bool, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'intermediate_requested': 'intermediate_requested',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, guid, type, asset, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            intermediate_requested (bool, none_type): Whether this account was explicitly requested by the caller as an intermediate account.. [optional]  # noqa: E501
        """
