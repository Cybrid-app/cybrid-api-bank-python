...
def lazy_import():
    ...
    globals()['InternalStage'] = InternalStage
    globals()['PlanTravelRuleInfo'] = PlanTravelRuleInfo


class InternalPlan(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'stages': ([InternalStage],),  # noqa: E501
    ...
    def _from_openapi_data(cls, guid, type, created_at, updated_at, expires_at, state, source_account, destination_account, stages, fees, travel_rule_info, *args, **kwargs):  # noqa: E501
        """InternalPlan - a model defined in OpenAPI
        ...
        Args:
            ...
            stages ([InternalStage]): Array of stages
            fees ([InternalFeeAssociation]): The fees associated with the plan.
