...
class PatchInternalWorkflow(ModelNormal):
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalWorkflow - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_code (str, none_type): The failure code for failed workflows.. [optional]  # noqa: E501
        """
