...
class PostInternalInternalWalletConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, transfer_wallet_guid, asset, *args, **kwargs):  # noqa: E501
        """PostInternalInternalWalletConfiguration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            invoice_wallet_guid (str, none_type): The identifier of the internal wallet to use for invoices. This must be a Strike internal wallet.. [optional]  # noqa: E501
            storage_wallet_guid (str, none_type): The identifier of the internal wallet to use for storage. This must be a BitGo internal wallet.. [optional]  # noqa: E501
        """
        ...
        self.type = type
        self.transfer_wallet_guid = transfer_wallet_guid
        self.asset = asset
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, transfer_wallet_guid, asset, *args, **kwargs):  # noqa: E501
        """PostInternalInternalWalletConfiguration - a model defined in OpenAPI
