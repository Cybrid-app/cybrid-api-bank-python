...
def lazy_import():
    ...
    globals()['InternalInvoice'] = InternalInvoice


class InternalInternalInvoiceList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalInvoice],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalInternalInvoiceList - a model defined in OpenAPI
