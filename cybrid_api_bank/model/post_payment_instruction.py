...
class PostPaymentInstruction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'expected_behaviour': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, invoice_guid, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expected_behaviour (str): The optional expected behaviour to simulate.. [optional] if omitted the server will use the default value of "invoice_paid_immediately"  # noqa: E501
        """
