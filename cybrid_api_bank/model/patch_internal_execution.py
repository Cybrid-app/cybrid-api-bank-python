...
class PatchInternalExecution(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'state': (str,),  # noqa: E501
            'source_executed_amount': (int, none_type,),  # noqa: E501
            'destination_executed_amount': (int, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'source_executed_amount': 'source_executed_amount',  # noqa: E501
        'destination_executed_amount': 'destination_executed_amount',  # noqa: E501
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalExecution - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            source_executed_amount (int, none_type): The executed amount for source account. [optional]  # noqa: E501
            destination_executed_amount (int, none_type): The executed amount for destination account. [optional]  # noqa: E501
            started_at (datetime, none_type): The timestamp when the plan started.. [optional]  # noqa: E501
            completed_at (datetime, none_type): The timestamp when the plan completed.. [optional]  # noqa: E501
            failed_at (datetime, none_type): The timestamp when the plan failed.. [optional]  # noqa: E501
            failure_code (str, none_type): The failure code for the plan, if applicable.. [optional]  # noqa: E501
        """
