...
class PostCustomerAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, street, city, country_code, *args, **kwargs):  # noqa: E501
        """PostCustomerAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            street2 (str, none_type): The optional second line of the address.. [optional]  # noqa: E501
            subdivision (str, none_type): The ISO 3166-2 subdivision code of the address. Applicable only for countries that use subnational states, provinces, lands, oblasts or regions.. [optional]  # noqa: E501
            postal_code (str, none_type): The postal, zip or post code of the address. Applicable only for countries that use postal, zip or post codes.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, street, city, country_code, *args, **kwargs):  # noqa: E501
        """PostCustomerAddress - a model defined in OpenAPI
