...
class PostCustomerAddress(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            subdivision (str, none_type): The ISO 3166-2 subdivision code of the address; not used by all countries. Optional when type is individual.. [optional]  # noqa: E501
            postal_code (str, none_type): The postal/post/zip code of the address; not used by all countries. Optional when type is individual.. [optional]  # noqa: E501
