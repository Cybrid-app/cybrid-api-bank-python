...
def lazy_import():
    ...
    globals()['ActivityLimit'] = ActivityLimit
    globals()['ComplianceDecision'] = ComplianceDecision
    globals()['CustomerAddress'] = CustomerAddress
    globals()['CustomerAliasesInner'] = CustomerAliasesInner
    globals()['CustomerName'] = CustomerName
    globals()['IdentificationNumber'] = IdentificationNumber
...
class Customer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'state': (str,),  # noqa: E501
            'name': (CustomerName,),  # noqa: E501
            'address': (CustomerAddress,),  # noqa: E501
            'aliases': ([CustomerAliasesInner], none_type,),  # noqa: E501
            ...
            'compliance_decisions': ([ComplianceDecision],),  # noqa: E501
            'identification_numbers': ([IdentificationNumber], none_type,),  # noqa: E501
            'activity_limits': ([ActivityLimit],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'compliance_decisions': 'compliance_decisions',  # noqa: E501
        'identification_numbers': 'identification_numbers',  # noqa: E501
        'activity_limits': 'activity_limits',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            guid (str): Auto-generated unique identifier for the customer.. [optional]  # noqa: E501
            bank_guid (str): Auto-generated unique identifier for the customer's bank.. [optional]  # noqa: E501
            type (str): The customer type; one of business or individual.. [optional]  # noqa: E501
            ...
            state (str): The customer state; one of storing, unverified, verified, rejected, or frozen.. [optional]  # noqa: E501
            name (CustomerName): [optional]  # noqa: E501
            address (CustomerAddress): [optional]  # noqa: E501
            aliases ([CustomerAliasesInner], none_type): The customer's aliases. Only available for GET operations when 'include_pii' is set.. [optional]  # noqa: E501
            website (str, none_type): The customer's website. Only available for GET operations when 'include_pii' is set.. [optional]  # noqa: E501
            date_of_birth (date, none_type): The customer's DOB. Only available for GET operations when 'include_pii' is set.. [optional]  # noqa: E501
            phone_number (str, none_type): The customer's phone number. Only available for GET operations when 'include_pii' is set.. [optional]  # noqa: E501
            email_address (str, none_type): The customer's email address. Only available for GET operations when 'include_pii' is set.. [optional]  # noqa: E501
            citizenship (str, none_type): The ISO 3166 country 2-Alpha country code of the customer's citizenship. Only available for GET operations when 'include_pii' is set.. [optional]  # noqa: E501
            labels ([str], none_type): The labels associated with the customer.. [optional]  # noqa: E501
            compliance_decisions ([ComplianceDecision]): The compliance decisions associated with the customer.. [optional]  # noqa: E501
            identification_numbers ([IdentificationNumber], none_type): The customer's identification numbers. Only available for GET operations when 'include_pii' is set and bank has access.. [optional]  # noqa: E501
            activity_limits ([ActivityLimit]): The asset limits associated with the customer.. [optional]  # noqa: E501
        """
