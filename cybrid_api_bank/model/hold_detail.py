...
class HoldDetail(ModelNormal):
    ...
    allowed_values = {
        ...
        ('type',): {
            ...
            'RESERVE_BELOW_MINIMUM': "reserve_below_minimum",
            'SCREENING_ADMINISTRATIVE': "screening_administrative",
            'SCREENING_NON_ADMINISTRATIVE': "screening_non_administrative",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'eta_at': (datetime, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state, started_at, *args, **kwargs):  # noqa: E501
        """HoldDetail - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str, none_type): The type of hold; one of customer_hold_duration, reserve_below_minimum, screening_administrative, or screening_non_administrative.. [optional]  # noqa: E501
            completed_at (datetime, none_type): ISO8601 datetime the hold was completed at.. [optional]  # noqa: E501
            eta_at (datetime, none_type): ISO8601 datetime the hold is expected to complete at.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, state, started_at, *args, **kwargs):  # noqa: E501
        """HoldDetail - a model defined in OpenAPI
