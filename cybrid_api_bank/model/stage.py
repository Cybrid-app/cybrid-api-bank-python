...
class Stage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, type, state, created_at, updated_at, source_account, destination_account, fees, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, type, state, created_at, updated_at, source_account, destination_account, fees, *args, **kwargs):  # noqa: E501
        """Stage - a model defined in OpenAPI
