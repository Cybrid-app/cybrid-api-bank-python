...
def lazy_import():
    ...
    globals()['EffectiveRate'] = EffectiveRate
    globals()['FeeAssociation'] = FeeAssociation
    globals()['PayoutReturnDetails'] = PayoutReturnDetails
...
class Stage(ModelNormal):
    ...
    def _from_openapi_data(cls, guid, type, state, identifiers, links, created_at, updated_at, source_account, destination_account, fees, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            type (str): The type of stage; one of payout, deposit, withdrawal, trade, deposit_return, loss_recovery, withdrawal_return, or payout_return.
