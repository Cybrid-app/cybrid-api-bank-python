...
class PatchInternalInvoice(ModelNormal):
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalInvoice - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            provider_id (str, none_type): The external identifier for the invoice.. [optional]  # noqa: E501
        """
