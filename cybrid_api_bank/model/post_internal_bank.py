...
class PostInternalBank(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, organization_guid, type, name, supported_trading_symbols, supported_fiat_account_assets, supported_country_codes, features, *args, **kwargs):  # noqa: E501
        """PostInternalBank - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            supported_payout_symbols ([PostSupportedPayoutSymbols], none_type): The payout symbols supported by the bank.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, organization_guid, type, name, supported_trading_symbols, supported_fiat_account_assets, supported_country_codes, features, *args, **kwargs):  # noqa: E501
        """PostInternalBank - a model defined in OpenAPI
