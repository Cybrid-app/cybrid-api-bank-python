...
class PostInternalTransactionMonitor(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'polling_interval': (int, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostInternalTransactionMonitor - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): Type of transaction_monitor to create.. defaults to "account", must be one of ["account", ]  # noqa: E501
            ...
            account_guid (str, none_type): The account identifier. Required when type is account.. [optional]  # noqa: E501
            direction (str, none_type): The direction to monitor for transactions Optional when type is account.. [optional]  # noqa: E501
            polling_interval (int, none_type): The interval in seconds to poll for transactions. Required when type is account.. [optional]  # noqa: E501
            start_date (date, none_type): The date to start monitoring transactions. Required when type is account.. [optional]  # noqa: E501
        """
