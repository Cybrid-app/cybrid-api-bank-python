...
class DepositAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, bank_guid, customer_guid, account_guid, created_at, asset, state, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, bank_guid, customer_guid, account_guid, created_at, asset, state, *args, **kwargs):  # noqa: E501
        """DepositAddress - a model defined in OpenAPI
