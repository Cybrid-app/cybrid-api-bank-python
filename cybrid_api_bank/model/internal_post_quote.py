...
class InternalPostQuote(ModelNormal):
    ...
    allowed_values = {
        ('product_type',): {
            ...
            'LOSS_RECOVERY_TRANSFER': "loss_recovery_transfer",
        },
        ('side',): {
            'BUY': "buy",
            'SELL': "sell",
    ...
    def openapi_types():
        ...
        return {
            ...
            'side': (str,),  # noqa: E501
            'receive_amount': (int, none_type,),  # noqa: E501
            'deliver_amount': (int, none_type,),  # noqa: E501
            'environment': (str,),  # noqa: E501
            'source_account_guid': (str, none_type,),  # noqa: E501
            'destination_account_guid': (str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_type, *args, **kwargs):  # noqa: E501
        """InternalPostQuote - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            symbol (str, none_type): Symbol the quote is being requested for. Format is \"asset-counter_asset\" in uppercase. See the Symbols API for a complete list of cryptocurrencies supported. Populated for trade quotes.. [optional]  # noqa: E501
            asset (str, none_type): The asset code the quote was requested for.. [optional]  # noqa: E501
            side (str): The direction for trade quotes: either 'buy' or 'sell'. The direction for funding quotes: either 'deposit' or 'withdrawal'. The direction for book transfer quotes: either 'deposit' or 'withdrawal'. The direction for crypto transfer quotes: 'withdrawal'. . [optional]  # noqa: E501
            receive_amount (int, none_type): The amount to be received in base units of the currency: currency is \"asset\" for buy and \"counter_asset\" for sell for trade quotes.. [optional]  # noqa: E501
            deliver_amount (int, none_type): The amount to be delivered in base units of the currency: currency is \"counter_asset\" for buy and \"asset\" for sell for trade quotes.. [optional]  # noqa: E501
            environment (str): The environment the quote is for.. [optional]  # noqa: E501
            source_account_guid (str, none_type): The source account guid.. [optional]  # noqa: E501
            destination_account_guid (str, none_type): The destination account guid.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_type, *args, **kwargs):  # noqa: E501
        """InternalPostQuote - a model defined in OpenAPI
