...
class PostInternalTrade(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, trade_type, quote_guid, environment, *args, **kwargs):  # noqa: E501
        """PostInternalTrade - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            source_account_guid (str, none_type): The identifier for the source account to use for the trade. Required if there are multiple cybrid accounts.. [optional]  # noqa: E501
            destination_account_guid (str, none_type): The identifier for the destination account to use for the trade. Required if there are multiple cybrid accounts.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, trade_type, quote_guid, environment, *args, **kwargs):  # noqa: E501
        """PostInternalTrade - a model defined in OpenAPI
