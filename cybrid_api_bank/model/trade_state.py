...
class TradeState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["storing", "pending", "cancelled", "completed", "settling", "failed", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["storing", "pending", "cancelled", "completed", "settling", "failed", ]  # noqa: E501
