...
def lazy_import():
    ...
    globals()['PostSignalInternalIdentityVerificationBankAccountHolderAddress'] = PostSignalInternalIdentityVerificationBankAccountHolderAddress
    globals()['PostSignalInternalIdentityVerificationBankAccountHolderName'] = PostSignalInternalIdentityVerificationBankAccountHolderName


class PostSignalInternalIdentityVerification(ModelNormal):
    ...
    allowed_values = {
        ...
        ('failure_codes',): {
            ...
            'ID_QUALITY_CHECK_FAILURE': "id_quality_check_failure",
            'ID_MRZ_CHECK_FAILURE': "id_mrz_check_failure",
            'ID_BARCODE_CHECK_FAILURE': "id_barcode_check_failure",
            'ID_PRESENCE_CHECK_FAILURE': "id_presence_check_failure",
            'ID_EXPIRATION_CHECK_FAILURE': "id_expiration_check_failure",
            'ID_DOUBLE_SIDE_CHECK_FAILURE': "id_double_side_check_failure",
            'ID_TYPE_ALLOWED_CHECK_FAILURE': "id_type_allowed_check_failure",
            'ID_COUNTRY_ALLOWED_CHECK_FAILURE': "id_country_allowed_check_failure",
            'ID_DIGITAL_REPLICA_CHECK_FAILURE': "id_digital_replica_check_failure",
            'ID_PAPER_REPLICA_CHECK_FAILURE': "id_paper_replica_check_failure",
            'DATABASE_CHECK_FAILURE': "database_check_failure",
            'SELFIE_FAILURE': "selfie_failure",
            'SELFIE_POSE_CHECK_FAILURE': "selfie_pose_check_failure",
            'SELFIE_QUALITY_CHECK_FAILURE': "selfie_quality_check_failure",
            ...
            'BANNED_NAME_CHECK_FAILURE': "banned_name_check_failure",
            'PROHIBITED_PERSON_CHECK_FAILURE': "prohibited_person_check_failure",
            'BANNED_IP_ADDRESS_CHECK_FAILURE': "banned_ip_address_check_failure",
            'COUNTRY_COMPARISON_CHECK_FAILURE': "country_comparison_check_failure",
            'DUPLICATE_PERSON_CHECK_FAILURE': "duplicate_person_check_failure",
            'NAME_CHECK_FAILURE': "name_check_failure",
            'ADDRESS_CHECK_FAILURE': "address_check_failure",
            'ACCOUNT_NUMBER_CHECK_FAILURE': "account_number_check_failure",
            ...
            'DOCUMENT_TYPE_CHECK_FAILURE': "document_type_check_failure",
            'DOCUMENT_QUALITY_CHECK_FAILURE': "document_quality_check_failure",
            ...
            'PLAID_INVALID_PRODUCT': "plaid_invalid_product",
            'PLAID_ITEM_NOT_FOUND': "plaid_item_not_found",
            'PLAID_NO_ACCOUNTS': "plaid_no_accounts",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'failure_codes': ([str],),  # noqa: E501
            'bank_account_holder_name': (PostSignalInternalIdentityVerificationBankAccountHolderName,),  # noqa: E501
            'bank_account_holder_address': (PostSignalInternalIdentityVerificationBankAccountHolderAddress,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'failure_codes': 'failure_codes',  # noqa: E501
        'bank_account_holder_name': 'bank_account_holder_name',  # noqa: E501
        'bank_account_holder_address': 'bank_account_holder_address',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, reference_id, comment, decision, failure_codes, *args, **kwargs):  # noqa: E501
        """PostSignalInternalIdentityVerification - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            bank_account_holder_name (PostSignalInternalIdentityVerificationBankAccountHolderName): [optional]  # noqa: E501
            bank_account_holder_address (PostSignalInternalIdentityVerificationBankAccountHolderAddress): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, reference_id, comment, decision, failure_codes, *args, **kwargs):  # noqa: E501
        """PostSignalInternalIdentityVerification - a model defined in OpenAPI
