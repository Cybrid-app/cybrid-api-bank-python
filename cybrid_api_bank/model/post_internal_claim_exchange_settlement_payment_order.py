...
def lazy_import():
    ...
    globals()['PostInternalSystemTransaction'] = PostInternalSystemTransaction


class PostInternalClaimExchangeSettlementPaymentOrder(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'system_transaction': (PostInternalSystemTransaction,),  # noqa: E501
        }
    ...
    attribute_map = {
        'system_transaction': 'system_transaction',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, system_transaction, *args, **kwargs):  # noqa: E501
        """PostInternalClaimExchangeSettlementPaymentOrder - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, system_transaction, *args, **kwargs):  # noqa: E501
        """PostInternalClaimExchangeSettlementPaymentOrder - a model defined in OpenAPI
