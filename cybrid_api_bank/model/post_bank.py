...
class PostBank(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, supported_trading_symbols, features, supported_fiat_account_assets, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, supported_trading_symbols, features, supported_fiat_account_assets, *args, **kwargs):  # noqa: E501
        """PostBank - a model defined in OpenAPI
