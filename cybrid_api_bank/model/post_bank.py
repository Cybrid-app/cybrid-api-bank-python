...
def lazy_import():
    ...
    globals()['PostSupportedPayoutSymbols'] = PostSupportedPayoutSymbols
...
class PostBank(ModelNormal):
    ...
    allowed_values = {
        ...
        ('features',): {
            ...
            'ATTESTATION_IDENTITY_RECORDS_V3': "attestation_identity_records_v3",
    ...
    def openapi_types():
        ...
        return {
            ...
            'supported_payout_symbols': ([PostSupportedPayoutSymbols], none_type,),  # noqa: E501
            'cors_allowed_origins': ([str], none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, supported_trading_symbols, supported_fiat_account_assets, supported_country_codes, features, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): The type of bank.. defaults to "sandbox", must be one of ["sandbox", ]  # noqa: E501
            ...
            supported_payout_symbols ([PostSupportedPayoutSymbols], none_type): The payout symbols supported by the bank. This is not yet supported and should be nil or empty.. [optional]  # noqa: E501
            cors_allowed_origins ([str], none_type): The list of allowed CORS origin URIs.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, supported_trading_symbols, supported_fiat_account_assets, supported_country_codes, features, *args, **kwargs):  # noqa: E501
        """PostBank - a model defined in OpenAPI
