...
class PostBank(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'supported_savings_configuration': ({str: ([str],)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'supported_savings_configuration': 'supported_savings_configuration',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, supported_trading_symbols, features, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            supported_savings_configuration ({str: ([str],)}): The bank's list of supported savings asset by provider.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, supported_trading_symbols, features, *args, **kwargs):  # noqa: E501
        """PostBank - a model defined in OpenAPI
