...
class PostBank(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'routable_accounts': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'routable_accounts': 'routable_accounts',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, name, supported_trading_symbols, features, supported_fiat_account_assets, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            routable_accounts (str): Configuration for supporting creating routable bank accounts.. [optional]  # noqa: E501
        """
