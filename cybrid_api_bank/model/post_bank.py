...
class PostBank(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, supported_fiat_assets, features, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, supported_fiat_assets, features, *args, **kwargs):  # noqa: E501
        """PostBank - a model defined in OpenAPI
