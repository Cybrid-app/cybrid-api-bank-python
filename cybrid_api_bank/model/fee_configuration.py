...
class FeeConfiguration(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FeeConfiguration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            product_type (str): The type of product being configured.. [optional] if omitted the server will use the default value of "trading"  # noqa: E501
