...
class InternalFeeCharge(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, environment, guid, created_at, updated_at, asset, amount, source_account_guid, destination_account_guid, state, *args, **kwargs):  # noqa: E501
        """InternalFeeCharge - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): The type of the entity.. defaults to "platform_assignment", must be one of ["platform_assignment", ]  # noqa: E501
            ...
            failure_code (str, none_type): The failure code if the entity is in a failed state.. [optional] if omitted the server will use the default value of "non_sufficient_funds"  # noqa: E501
            exchange_order_guid (str, none_type): The exchange order identifier. Required when type is platform_assignment.. [optional]  # noqa: E501
        """
        ...
        self.asset = asset
        self.amount = amount
        self.source_account_guid = source_account_guid
        self.destination_account_guid = destination_account_guid
        self.state = state
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment, guid, created_at, updated_at, asset, amount, source_account_guid, destination_account_guid, state, *args, **kwargs):  # noqa: E501
        """InternalFeeCharge - a model defined in OpenAPI
