...
class PaymentInstructionList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([PaymentInstruction],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """PaymentInstructionList - a model defined in OpenAPI
