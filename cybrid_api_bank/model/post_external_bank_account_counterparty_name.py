...
class PostExternalBankAccountCounterpartyName(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostExternalBankAccountCounterpartyName - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            first (str, none_type): The counterparty's first name; used for individuals. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            middle (str, none_type): The counterparty's middle name; used for individuals. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            last (str, none_type): The counterparty's last name; used for individuals. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            full (str, none_type): The counterparty's full name; used for businesses. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
        """
