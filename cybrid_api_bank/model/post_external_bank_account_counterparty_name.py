...
class PostExternalBankAccountCounterpartyName(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            first (str, none_type): The holder's first name; used for individuals. Optional when account_kind is raw_routing_details.. [optional]  # noqa: E501
            middle (str, none_type): The holder's middle name; used for individuals. Optional when account_kind is raw_routing_details.. [optional]  # noqa: E501
            last (str, none_type): The holder's last name; used for individuals. Optional when account_kind is raw_routing_details.. [optional]  # noqa: E501
            full (str, none_type): The holder's full name; used for businesses. Optional when account_kind is raw_routing_details.. [optional]  # noqa: E501
        """
