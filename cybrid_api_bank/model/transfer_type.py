...
class TransferType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["funding", "book", "crypto", "instant_funding", "funding_return", "crypto_return", "loss_recovery", "inter_account", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["funding", "book", "crypto", "instant_funding", "funding_return", "crypto_return", "loss_recovery", "inter_account", ]  # noqa: E501
