...
class SymbolPriceResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SymbolPriceResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SymbolPrice]): Array of SymbolPrice entities.  # noqa: E501

        Keyword Args:
            value ([SymbolPrice]): Array of SymbolPrice entities.  # noqa: E501
