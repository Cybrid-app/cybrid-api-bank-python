...
def lazy_import():
    ...
    globals()['PostOneTimeAddress'] = PostOneTimeAddress
...
class PostTransfer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'one_time_address': (PostOneTimeAddress,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'one_time_address': 'one_time_address',  # noqa: E501
    ...
    def _from_openapi_data(cls, quote_guid, transfer_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            external_bank_account_guid (str): The customer's fiat asset external bank account's identifier.. [optional]  # noqa: E501
            one_time_address (PostOneTimeAddress): [optional]  # noqa: E501
