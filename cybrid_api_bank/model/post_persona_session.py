...
class PostPersonaSession(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, persona_inquiry_id, identity_verification_guid, *args, **kwargs):  # noqa: E501
        """PostPersonaSession - a model defined in OpenAPI

        Args:
            persona_inquiry_id (str): The ID of the Persona inquiry to create a session for
            identity_verification_guid (str): The GUID of the identity verification associated with the session
    ...
    @convert_js_args_to_python_args
    def __init__(self, persona_inquiry_id, identity_verification_guid, *args, **kwargs):  # noqa: E501
        """PostPersonaSession - a model defined in OpenAPI
