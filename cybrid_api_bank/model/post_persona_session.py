...
class PostPersonaSession(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, persona_inquiry_id, customer_guid, identity_verification_guid, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, persona_inquiry_id, customer_guid, identity_verification_guid, *args, **kwargs):  # noqa: E501
        """PostPersonaSession - a model defined in OpenAPI
