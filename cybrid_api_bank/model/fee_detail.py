...
class FeeDetail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, asset, amount, *args, **kwargs):  # noqa: E501
        """FeeDetail - a model defined in OpenAPI

        Args:
            type (str): The type of fee; one of bank, platform, or network.
            asset (str): The asset the fee is denominated in, e.g., USD.
            amount (int): The fee amount in base units of the asset.
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, asset, amount, *args, **kwargs):  # noqa: E501
        """FeeDetail - a model defined in OpenAPI
