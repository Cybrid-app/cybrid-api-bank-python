...
class PostExternalBankAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, asset, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            account_kind (str): The account type. defaults to "plaid", must be one of ["plaid", ]  # noqa: E501
        ...
        account_kind = kwargs.get('account_kind', "plaid")
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, asset, *args, **kwargs):  # noqa: E501
        """PostExternalBankAccount - a model defined in OpenAPI
