...
class InternalInternalBankAccountConfiguration(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InternalInternalBankAccountConfiguration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            transfer_bank_account_guid (str): The identifier of the internal bank account to use for transfers.. [optional]  # noqa: E501
            deposit_bank_account_guid (str): The identifier of the internal bank account to use for creating deposit accounts.. [optional]  # noqa: E501
            invoice_bank_account_guid (str, none_type): The identifier of the internal bank account to use for creating invoice accounts.. [optional]  # noqa: E501
