...
class VerificationCheckType(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'EXTERNAL_BANK_ACCOUNT_VERIFICATION': "external_bank_account_verification",
            'EXTERNAL_BANK_ACCOUNT_ATTESTED': "external_bank_account_attested",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["business_watchlists", "business_verification", "business_tax_id_verification", "person_attested", "person_tax_id_attested", "person_watchlists", "person_verification", "person_authentication", "person_gov_id_verification", "person_tax_id_verification", "external_bank_account_verification", "external_bank_account_attested", ]  # noqa: E501
