...
class StageIdentifier(ModelNormal):
    ...
    def _from_openapi_data(cls, type, value, *args, **kwargs):  # noqa: E501
        """StageIdentifier - a model defined in OpenAPI

        Args:
            type (str): The kind of identifier.
            value (str): The identifier value as issued by the rail.
