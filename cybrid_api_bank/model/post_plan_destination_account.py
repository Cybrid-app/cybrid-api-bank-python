...
class PostPlanDestinationAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, guid, *args, **kwargs):  # noqa: E501
        """PostPlanDestinationAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            amount (int, none_type): The amount to be delivered in base units of the source account currency. [optional]  # noqa: E501
            payment_rail (str, none_type): The desired payment rail to use to initiate a fiat transfer to the destination account.. [optional]  # noqa: E501
        """
