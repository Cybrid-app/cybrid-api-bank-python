...
class PostIdentityVerificationRegisteredAddress(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostIdentityVerificationRegisteredAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            street (str, none_type): The first line of the address. Required when type is kyc and method is attested_business_registration.. [optional]  # noqa: E501
            street2 (str, none_type): The optional second line of the address. Optional when type is kyc and method is attested_business_registration.. [optional]  # noqa: E501
            city (str, none_type): The city of the address. Required when type is kyc and method is attested_business_registration.. [optional]  # noqa: E501
            subdivision (str, none_type): The ISO 3166-2 subdivision code of the address. Applicable only for countries that use subnational states, provinces, lands, oblasts or regions. Optional when type is kyc and method is attested_business_registration.. [optional]  # noqa: E501
            postal_code (str, none_type): The postal, zip or post code of the address. Applicable only for countries that use postal, zip or post codes. Optional when type is kyc and method is attested_business_registration.. [optional]  # noqa: E501
            country_code (str, none_type): The ISO 3166 country 2-Alpha country code of the address. Required when type is kyc and method is attested_business_registration.. [optional]  # noqa: E501
        """
