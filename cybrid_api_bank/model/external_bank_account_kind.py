...
class ExternalBankAccountKind(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            'MODERN_TREASURY_EXTERNAL_ACCOUNT': "modern_treasury_external_account",
            'PLAID': "plaid",
    ...
    def __init__(self, *args, **kwargs):
        """ExternalBankAccountKind - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["modern_treasury_external_account", "plaid", "plaid_processor_token", "raw_routing_details", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["modern_treasury_external_account", "plaid", "plaid_processor_token", "raw_routing_details", ]  # noqa: E501
