...
class ExternalBankAccountKind(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["plaid", "plaid_processor_token", "raw_routing_details", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["plaid", "plaid_processor_token", "raw_routing_details", ]  # noqa: E501
