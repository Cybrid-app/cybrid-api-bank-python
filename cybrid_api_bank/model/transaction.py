...
def lazy_import():
    ...
    globals()['TransactionResource'] = TransactionResource
...
class Transaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_guid, amount, asset, bank_guid, direction, posted, created_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            customer_guid (str, none_type): The unique identifier for the customer. Absent for bank-owned accounts.. [optional]  # noqa: E501
            category (str, none_type): The type of ledger line item, e.g., principal or fee.. [optional]  # noqa: E501
            resource (TransactionResource): [optional]  # noqa: E501
            balance (Balance): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_guid, amount, asset, bank_guid, direction, posted, created_at, *args, **kwargs):  # noqa: E501
        """Transaction - a model defined in OpenAPI
