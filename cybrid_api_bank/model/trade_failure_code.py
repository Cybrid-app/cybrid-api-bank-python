...
class TradeFailureCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["non_sufficient_funds", "unsupported", "limit_exceeded", "expired_quote", "market_volatility", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["non_sufficient_funds", "unsupported", "limit_exceeded", "expired_quote", "market_volatility", ]  # noqa: E501
