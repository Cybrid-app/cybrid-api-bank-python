...
class TradeFailureCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["non_sufficient_funds", "unsupported", "limit_exceeded", "expired_quote", "market_volatility", "not_filled", "daily_limit_exceeded", "weekly_limit_exceeded", "monthly_limit_exceeded", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["non_sufficient_funds", "unsupported", "limit_exceeded", "expired_quote", "market_volatility", "not_filled", "daily_limit_exceeded", "weekly_limit_exceeded", "monthly_limit_exceeded", ]  # noqa: E501
