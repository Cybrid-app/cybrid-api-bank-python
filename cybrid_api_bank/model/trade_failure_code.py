...
class TradeFailureCode(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'LIFETIME_LIMIT_EXCEEDED': "lifetime_limit_exceeded",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """TradeFailureCode - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["non_sufficient_funds", "unsupported", "limit_exceeded", "expired_quote", "market_volatility", "not_filled", "daily_limit_exceeded", "weekly_limit_exceeded", "monthly_limit_exceeded", "lifetime_limit_exceeded", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["non_sufficient_funds", "unsupported", "limit_exceeded", "expired_quote", "market_volatility", "not_filled", "daily_limit_exceeded", "weekly_limit_exceeded", "monthly_limit_exceeded", "lifetime_limit_exceeded", ]  # noqa: E501
