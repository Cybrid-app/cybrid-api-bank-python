...
class PostFeeConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset, fees, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            product_type (str): The type of product being configured.. defaults to "trading", must be one of ["trading", ]  # noqa: E501
        ...
        product_type = kwargs.get('product_type', "trading")
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset, fees, *args, **kwargs):  # noqa: E501
        """PostFeeConfiguration - a model defined in OpenAPI
