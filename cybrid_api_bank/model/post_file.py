...
def lazy_import():
    ...
    globals()['PostFileMetadata'] = PostFileMetadata


class PostFile(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            ...
            'INDIGENOUS_ID_DOCUMENT': "indigenous_id_document",
            'SELFIE': "selfie",
    ...
    def openapi_types():
        ...
        return {
            ...
            'metadata': (PostFileMetadata,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, customer_guid, filename, content_type, *args, **kwargs):  # noqa: E501
        """PostFile - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data (str, none_type): Base64 encoded file content. [optional]  # noqa: E501
            metadata (PostFileMetadata): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, customer_guid, filename, content_type, *args, **kwargs):  # noqa: E501
        """PostFile - a model defined in OpenAPI
