...
class PostSignalInternalExternalWalletScreening(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, reference_id, comment, outcome, *args, **kwargs):  # noqa: E501
        """PostSignalInternalExternalWalletScreening - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, reference_id, comment, outcome, *args, **kwargs):  # noqa: E501
        """PostSignalInternalExternalWalletScreening - a model defined in OpenAPI
