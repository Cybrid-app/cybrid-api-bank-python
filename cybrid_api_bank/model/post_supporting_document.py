...
class PostSupportingDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'file_guids': ([str],),  # noqa: E501
            'document_reference_number': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'type': 'type',  # noqa: E501
        'file_guids': 'file_guids',  # noqa: E501
        'document_reference_number': 'document_reference_number',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, file_guids, *args, **kwargs):  # noqa: E501
        """PostSupportingDocument - a model defined in OpenAPI

        Args:
            type (str): The kind of supporting document.
            file_guids ([str]): File guids backing this document.
        ...
        Keyword Args:
            ...
            document_reference_number (str, none_type): A reference number identifying this document (e.g. an invoice number). Required for payouts to certain corridors.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, file_guids, *args, **kwargs):  # noqa: E501
        """PostSupportingDocument - a model defined in OpenAPI
