...
class PostSupportingDocument(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, file_guids, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): The kind of supporting document.. defaults to "invoice", must be one of ["invoice", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, file_guids, *args, **kwargs):  # noqa: E501
        """PostSupportingDocument - a model defined in OpenAPI
