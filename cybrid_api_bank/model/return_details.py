...
class ReturnDetails(ModelNormal):
    ...
    def _from_openapi_data(cls, returned_at, *args, **kwargs):  # noqa: E501
        """ReturnDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            return_code (str, none_type): The ACH/EFT return code (e.g. R01, R10) received from the provider. Absent when the provider did not report a return code.. [optional]  # noqa: E501
        """
