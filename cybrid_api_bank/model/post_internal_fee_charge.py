...
class PostInternalFeeCharge(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'exchange_order_guid': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'type': 'type',  # noqa: E501
        'exchange_order_guid': 'exchange_order_guid',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, environment, *args, **kwargs):  # noqa: E501
        """PostInternalFeeCharge - a model defined in OpenAPI

        Args:
            environment (str): The environment for the configuration.

        Keyword Args:
            type (str): The order type.. defaults to "platform_assignment", must be one of ["platform_assignment", ]  # noqa: E501
            ...
            exchange_order_guid (str, none_type): The exchange order guid to generate a fee charge for Required when type is platform_assignment.. [optional]  # noqa: E501
        """

        type = kwargs.get('type', "platform_assignment")
