...
class Execution(ModelNormal):
    ...
    def _from_openapi_data(cls, guid, type, plan_guid, created_at, updated_at, state, source_account, destination_account, stages, fees, travel_rule_info, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            references ([PlanReference], none_type): Objects this return execution references (the returned execution and stage). Optional when type is deposit_return or type is withdrawal_return.. [optional]  # noqa: E501
