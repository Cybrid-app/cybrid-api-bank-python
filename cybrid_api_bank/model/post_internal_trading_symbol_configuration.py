...
class PostInternalTradingSymbolConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, enabled, symbol, *args, **kwargs):  # noqa: E501
        """PostInternalTradingSymbolConfiguration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            execution_mode (str, none_type): The execution mode for the configuration Required when type is platform. Optional when type is bank.. [optional]  # noqa: E501
            bank_guid (str, none_type): The bank_guid for the configuration. Required when type is bank.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, enabled, symbol, *args, **kwargs):  # noqa: E501
        """PostInternalTradingSymbolConfiguration - a model defined in OpenAPI
