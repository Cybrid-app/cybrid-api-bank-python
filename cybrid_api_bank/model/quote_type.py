...
class QuoteType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["trading", "funding", "book_transfer", "crypto_transfer", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["trading", "funding", "book_transfer", "crypto_transfer", ]  # noqa: E501
