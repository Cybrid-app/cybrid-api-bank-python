...
class QuoteType(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'CRYPTO_TRANSFER_RETURN': "crypto_transfer_return",
            ...
            'LOSS_COVERAGE_TRANSFER': "loss_coverage_transfer",
            'LOSS_RECLAIM_TRANSFER': "loss_reclaim_transfer",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["trading", "funding", "book_transfer", "crypto_transfer", "funding_return", "trading_liquidation", "crypto_transfer_return", "loss_recovery_transfer", "inter_account", "lightning_transfer", "trading_exit", "loss_coverage_transfer", "loss_reclaim_transfer", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["trading", "funding", "book_transfer", "crypto_transfer", "funding_return", "trading_liquidation", "crypto_transfer_return", "loss_recovery_transfer", "inter_account", "lightning_transfer", "trading_exit", "loss_coverage_transfer", "loss_reclaim_transfer", ]  # noqa: E501
