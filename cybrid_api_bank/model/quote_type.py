...
class QuoteType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["trading", "trading_exit", "funding", "book_transfer", "crypto_transfer", "inter_account", "lightning_transfer", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["trading", "trading_exit", "funding", "book_transfer", "crypto_transfer", "inter_account", "lightning_transfer", ]  # noqa: E501
