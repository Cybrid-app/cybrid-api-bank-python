...
class PatchExternalBankAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PatchExternalBankAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            state (str, none_type): The state of the external bank account. If set to \"completed,\" the returned state of the external bank account will be either \"completed\", if the bank account has been verified, or \"unverified\" if the bank account has not been verified.. [optional]  # noqa: E501
            name (str, none_type): The name of the external bank account.. [optional]  # noqa: E501
        """
