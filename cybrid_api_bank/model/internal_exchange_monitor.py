...
class InternalExchangeMonitor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, created_at, updated_at, exchange_guid, cron_schedule, *args, **kwargs):  # noqa: E501
        """InternalExchangeMonitor - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            denied_symbols ([str], none_type): Array of trading symbol codes to deny; empty if all symbols are allowed.. [optional]  # noqa: E501
            allowed_symbols ([str], none_type): Array of trading symbol codes to allow; empty if all symbols should be allowed.. [optional]  # noqa: E501
            workday_countries ([str], none_type): Array of ISO 3166 country 2-Alpha country codes to use for workday calculations.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, created_at, updated_at, exchange_guid, cron_schedule, *args, **kwargs):  # noqa: E501
        """InternalExchangeMonitor - a model defined in OpenAPI
