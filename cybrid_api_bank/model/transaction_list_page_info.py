...
class TransactionListPageInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, next_cursor, *args, **kwargs):  # noqa: E501
        """TransactionListPageInfo - a model defined in OpenAPI

        Args:
            next_cursor (str, none_type): The cursor to retrieve the next page of records, or null if there is none.
    ...
    @convert_js_args_to_python_args
    def __init__(self, next_cursor, *args, **kwargs):  # noqa: E501
        """TransactionListPageInfo - a model defined in OpenAPI
