...
def lazy_import():
    ...
    globals()['PatchInternalAccountAssociation'] = PatchInternalAccountAssociation
    globals()['PatchInternalFeeAssociation'] = PatchInternalFeeAssociation


class PatchInternalStage(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'accounts': ([PatchInternalAccountAssociation], none_type,),  # noqa: E501
            'fees': ([PatchInternalFeeAssociation], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalStage - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            completed_at (datetime, none_type): The timestamp when the stage failed, if applicable.. [optional]  # noqa: E501
            failed_at (datetime, none_type): The timestamp when the stage failed, if applicable.. [optional]  # noqa: E501
            accounts ([PatchInternalAccountAssociation], none_type): The accounts associated with the stage.. [optional]  # noqa: E501
            fees ([PatchInternalFeeAssociation], none_type): The custom fees associated with the stage. [optional]  # noqa: E501
        """
