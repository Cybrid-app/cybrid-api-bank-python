...
class PostDepositBankAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, account_guid, *args, **kwargs):  # noqa: E501
        """PostDepositBankAccount - a model defined in OpenAPI
        ...
        Args:
            ...
            account_guid (str): The fiat or reserve account guid.
        ...
        Keyword Args:
            ...
            parent_deposit_bank_account_guid (str, none_type): The unique identifier for the bank-level deposit bank account. This is only required for sub-accounts. Required when type is sub_account.. [optional]  # noqa: E501
            labels ([str], none_type): The labels associated with the bank account.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, account_guid, *args, **kwargs):  # noqa: E501
        """PostDepositBankAccount - a model defined in OpenAPI
