...
class PostInternalCybridAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, asset, name, environment, *args, **kwargs):  # noqa: E501
        """PostInternalCybridAccount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, asset, name, environment, *args, **kwargs):  # noqa: E501
        """PostInternalCybridAccount - a model defined in OpenAPI
