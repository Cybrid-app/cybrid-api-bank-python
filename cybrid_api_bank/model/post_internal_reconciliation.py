...
class PostInternalReconciliation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, category, confidence, direction, transaction_id, transfer_guid, *args, **kwargs):  # noqa: E501
        """PostInternalReconciliation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, category, confidence, direction, transaction_id, transfer_guid, *args, **kwargs):  # noqa: E501
        """PostInternalReconciliation - a model defined in OpenAPI
