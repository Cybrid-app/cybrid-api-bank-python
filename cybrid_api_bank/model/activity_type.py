...
class ActivityType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The activity type., must be one of ["trading", "funding", "book_transfer", "crypto_transfer", "external", "internal", ]  # noqa: E501

        Keyword Args:
            value (str): The activity type., must be one of ["trading", "funding", "book_transfer", "crypto_transfer", "external", "internal", ]  # noqa: E501
