...
class PayoutReturnDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'returned_at': (datetime,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, returned_at, *args, **kwargs):  # noqa: E501
        """PayoutReturnDetails - a model defined in OpenAPI

        Args:
            returned_at (datetime): The timestamp when the return was initiated by the provider.
    ...
    @convert_js_args_to_python_args
    def __init__(self, returned_at, *args, **kwargs):  # noqa: E501
        """PayoutReturnDetails - a model defined in OpenAPI
