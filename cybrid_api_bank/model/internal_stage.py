...
def lazy_import():
    ...
    globals()['InternalFeeAssociation'] = InternalFeeAssociation


class InternalStage(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fees': ([InternalFeeAssociation],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, plan_guid, stage_index, type, state, created_at, updated_at, source_account, destination_account, fees, *args, **kwargs):  # noqa: E501
        """InternalStage - a model defined in OpenAPI
        ...
        Args:
            ...
            fees ([InternalFeeAssociation]): The fees associated with the stage.
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, plan_guid, stage_index, type, state, created_at, updated_at, source_account, destination_account, fees, *args, **kwargs):  # noqa: E501
        """InternalStage - a model defined in OpenAPI
