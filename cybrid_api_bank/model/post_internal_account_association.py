...
class PostInternalAccountAssociation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, side, asset, *args, **kwargs):  # noqa: E501
        """PostInternalAccountAssociation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            guid (str, none_type): The unique identifier for the account.. [optional]  # noqa: E501
            requested_amount (int, none_type): The requested amount in base units of the currency.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, side, asset, *args, **kwargs):  # noqa: E501
        """PostInternalAccountAssociation - a model defined in OpenAPI
