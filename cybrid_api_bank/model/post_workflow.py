...
class PostWorkflow(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            kind (str, none_type): The Plaid workflow kind. Required when type is plaid.. [optional]  # noqa: E501
            customer_guid (str, none_type): The customer identifier associated with the workflow. Optional when type is plaid and kind is link_token_create.. [optional]  # noqa: E501
            external_bank_account_guid (str, none_type): The external bank account identifier associated with the workflow. Required when type is plaid and kind is link_token_update.. [optional]  # noqa: E501
            language (str, none_type): The language to initialize Plaid link. Required when type is plaid.. [optional]  # noqa: E501
            link_customization_name (str, none_type): The customization name for Plaid link. For English, use \"default\". For Spanish, use \"spanish_customization\". Required when type is plaid.. [optional]  # noqa: E501
            redirect_uri (str, none_type): The redirect URI for Plaid link. Optional when type is plaid.. [optional]  # noqa: E501
            android_package_name (str, none_type): The Android package name for Plaid link. Optional when type is plaid.. [optional]  # noqa: E501
        """
