...
def lazy_import():
    ...
    globals()['InternalFeeConfiguration'] = InternalFeeConfiguration


class InternalFeeConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalFeeConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalFeeConfigurationList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalFeeConfiguration]): Array of entities
