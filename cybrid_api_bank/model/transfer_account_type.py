...
class TransferAccountType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["trading", "fiat", "external_bank_account", "external_wallet", "one_time_address", "reserve", "invoice_operations", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["trading", "fiat", "external_bank_account", "external_wallet", "one_time_address", "reserve", "invoice_operations", ]  # noqa: E501
