...
class TransferAccountType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TransferAccountType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["trading", "fiat", "external_bank_account", "external_wallet", "one_time_address", "reserve", "invoice_operations", "fee", "gas", "storage", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["trading", "fiat", "external_bank_account", "external_wallet", "one_time_address", "reserve", "invoice_operations", "fee", "gas", "storage", ]  # noqa: E501
