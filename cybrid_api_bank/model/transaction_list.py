...
def lazy_import():
    ...
    globals()['TransactionListPageInfo'] = TransactionListPageInfo


class TransactionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'page_info': (TransactionListPageInfo,),  # noqa: E501
            'objects': ([Transaction],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, page_info, objects, *args, **kwargs):  # noqa: E501
        """TransactionList - a model defined in OpenAPI

        Args:
            page_info (TransactionListPageInfo):
            objects ([Transaction]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, page_info, objects, *args, **kwargs):  # noqa: E501
        """TransactionList - a model defined in OpenAPI
