...
class Balance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, debits, credits, amount, *args, **kwargs):  # noqa: E501
        """Balance - a model defined in OpenAPI

        Args:
            debits (int): The total posted debits on the account, in base units.
            credits (int): The total posted credits on the account, in base units.
            amount (int): The balance on the account, in base units.
    ...
    @convert_js_args_to_python_args
    def __init__(self, debits, credits, amount, *args, **kwargs):  # noqa: E501
        """Balance - a model defined in OpenAPI
