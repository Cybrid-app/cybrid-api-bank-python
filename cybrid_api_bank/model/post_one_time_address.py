...
class PostOneTimeAddress(ModelNormal):
    ...
    def _from_openapi_data(cls, address, *args, **kwargs):  # noqa: E501
        """PostOneTimeAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tag (str, none_type): The blockchain tag to use when transferring crypto.. [optional]  # noqa: E501
        """
