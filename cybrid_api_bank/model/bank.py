...
class Bank(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, organization_guid, name, features, created_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): The bank's type.. defaults to "sandbox", must be one of ["sandbox", ]  # noqa: E501
            ...
            supported_fiat_assets ([str]): The bank's list of supported fiat assets.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, organization_guid, name, features, created_at, *args, **kwargs):  # noqa: E501
        """Bank - a model defined in OpenAPI
