...
class PostInternalExchangeOrder(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'source_payable_account_guid': (str, none_type,),  # noqa: E501
            'source_receivable_account_guid': (str, none_type,),  # noqa: E501
            'fixed_amount': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'fixed_amount': 'fixed_amount',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, environment, trade_guids, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeOrder - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): The order type.. defaults to "fixed", must be one of ["fixed", ]  # noqa: E501
            ...
            side (str, none_type): The side for the order.. [optional]  # noqa: E501
            symbol (str, none_type): The symbol for the order. [optional]  # noqa: E501
            deliver_amount (int, none_type): The amount to be delivered in base units of the currency. [optional]  # noqa: E501
            receive_amount (int, none_type): The amount to be received in base units of the currency. [optional]  # noqa: E501
            source_payable_account_guid (str, none_type): The source payable account guid to use for the order. [optional]  # noqa: E501
            source_receivable_account_guid (str, none_type): The source receivable account guid to use for the order. [optional]  # noqa: E501
            fixed_amount (str, none_type): The side to fix Optional when type is fixed.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment, trade_guids, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeOrder - a model defined in OpenAPI
