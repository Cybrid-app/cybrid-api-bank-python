...
class PatchInternalFeeAssociation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, step_identifier, executed_amount, *args, **kwargs):  # noqa: E501
        """PatchInternalFeeAssociation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, step_identifier, executed_amount, *args, **kwargs):  # noqa: E501
        """PatchInternalFeeAssociation - a model defined in OpenAPI
