...
class ComplianceCheck(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, outcome, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            outcome (str): The outcome of the compliance check; one of passed, failed, or inconclusive.
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, outcome, *args, **kwargs):  # noqa: E501
        """ComplianceCheck - a model defined in OpenAPI
