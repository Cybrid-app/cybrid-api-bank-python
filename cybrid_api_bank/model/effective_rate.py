...
class EffectiveRate(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'source_asset': (str,),  # noqa: E501
            'destination_asset': (str,),  # noqa: E501
            'quoted': (str, none_type,),  # noqa: E501
            'executed': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'source_asset': 'source_asset',  # noqa: E501
        'destination_asset': 'destination_asset',  # noqa: E501
        'quoted': 'quoted',  # noqa: E501
        'executed': 'executed',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_asset, destination_asset, *args, **kwargs):  # noqa: E501
        """EffectiveRate - a model defined in OpenAPI

        Args:
            source_asset (str): The asset converted from, e.g., USD.
            destination_asset (str): The asset converted to, e.g., MXN.
        ...
        Keyword Args:
            ...
            quoted (str, none_type): The quoted effective rate as a decimal string. Null until quoted amounts are known.. [optional]  # noqa: E501
            executed (str, none_type): The executed effective rate as a decimal string. Null until execution completes.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_asset, destination_asset, *args, **kwargs):  # noqa: E501
        """EffectiveRate - a model defined in OpenAPI
