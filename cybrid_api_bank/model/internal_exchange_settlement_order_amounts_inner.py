...
class InternalExchangeSettlementOrderAmountsInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'executed_deliver_amount': (int,),  # noqa: E501
            'unassigned_deliver_amount': (int,),  # noqa: E501
            'requested_receive_amount': (int,),  # noqa: E501
            'executed_receive_amount': (int,),  # noqa: E501
            'unassigned_receive_amount': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset, requested_deliver_amount, executed_deliver_amount, unassigned_deliver_amount, requested_receive_amount, executed_receive_amount, unassigned_receive_amount, *args, **kwargs):  # noqa: E501
        """InternalExchangeSettlementOrderAmountsInner - a model defined in OpenAPI
        ...
        self.executed_deliver_amount = executed_deliver_amount
        self.unassigned_deliver_amount = unassigned_deliver_amount
        self.requested_receive_amount = requested_receive_amount
        self.executed_receive_amount = executed_receive_amount
        self.unassigned_receive_amount = unassigned_receive_amount
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset, requested_deliver_amount, executed_deliver_amount, unassigned_deliver_amount, requested_receive_amount, executed_receive_amount, unassigned_receive_amount, *args, **kwargs):  # noqa: E501
        """InternalExchangeSettlementOrderAmountsInner - a model defined in OpenAPI
