...
class PostInternalExchangeMonitor(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cron_schedule': (str,),  # noqa: E501
            'allowed_symbols': ([str], none_type,),  # noqa: E501
            'denied_symbols': ([str], none_type,),  # noqa: E501
            'workday_countries': ([str], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'cron_schedule': 'cron_schedule',  # noqa: E501
        'allowed_symbols': 'allowed_symbols',  # noqa: E501
        'denied_symbols': 'denied_symbols',  # noqa: E501
        'workday_countries': 'workday_countries',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, exchange_guid, cron_schedule, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeMonitor - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            allowed_symbols ([str], none_type): The trading symbols to allow in the settlement; omit if all symbols should be allowed.. [optional]  # noqa: E501
            denied_symbols ([str], none_type): The trading symbols to deny in the settlement; omit if no symbols should be denied.. [optional]  # noqa: E501
            workday_countries ([str], none_type): The country codes to skip settlements on non-workdays; omit if workdays should not be factored.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, exchange_guid, cron_schedule, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeMonitor - a model defined in OpenAPI
