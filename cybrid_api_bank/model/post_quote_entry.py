...
class PostQuoteEntry(ModelNormal):
    ...
    def _from_openapi_data(cls, guid, *args, **kwargs):  # noqa: E501
        """PostQuoteEntry - a model defined in OpenAPI

        Args:
            guid (str): The guid of the account

        Keyword Args:
            type (str): The type of account. defaults to "external_wallet", must be one of ["external_wallet", ]  # noqa: E501
        ...
        type = kwargs.get('type', "external_wallet")
