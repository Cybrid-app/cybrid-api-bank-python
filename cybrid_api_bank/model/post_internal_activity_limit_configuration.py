...
def lazy_import():
    ...
    globals()['ParamInternalActivityLimit'] = ParamInternalActivityLimit


class PostInternalActivityLimitConfiguration(ModelNormal):
    ...
    allowed_values = {
        ...
        ('audience',): {
            'None': None,
            'INDIVIDUAL_TAX_ID_UNVERIFIED_CUSTOMER': "individual_tax_id_unverified_customer",
            'INDIVIDUAL_TAX_ID_VERIFIED_CUSTOMER': "individual_tax_id_verified_customer",
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'limits': ([ParamInternalActivityLimit],),  # noqa: E501
            'activity': (str, none_type,),  # noqa: E501
            'side': (str, none_type,),  # noqa: E501
            'environment': (str, none_type,),  # noqa: E501
            'audience': (str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, limits, *args, **kwargs):  # noqa: E501
        """PostInternalActivityLimitConfiguration - a model defined in OpenAPI

        Args:
            type (str): The type of the configuration.
            limits ([ParamInternalActivityLimit]): The limits for the configuration.
        ...
        Keyword Args:
            ...
            activity (str, none_type): The activity type of the configuration.. [optional]  # noqa: E501
            side (str, none_type): The side of the activity.. [optional]  # noqa: E501
            environment (str, none_type): The environment for the configuration. Required when type is platform.. [optional]  # noqa: E501
            audience (str, none_type): The audience for the configuration. Required when type is platform or type is bank.. [optional]  # noqa: E501
            country_code (str, none_type): The country code for the configuration. Required when type is platform.. [optional]  # noqa: E501
            bank_guid (str, none_type): The bank GUID for the configuration. Required when type is bank.. [optional]  # noqa: E501
            customer_guid (str, none_type): The customer GUID for the configuration. Required when type is customer.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, limits, *args, **kwargs):  # noqa: E501
        """PostInternalActivityLimitConfiguration - a model defined in OpenAPI
