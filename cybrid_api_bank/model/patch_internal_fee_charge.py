...
class PatchInternalFeeCharge(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PatchInternalFeeCharge - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_code (str, none_type): The error message in case of failure.. [optional] if omitted the server will use the default value of "non_sufficient_funds"  # noqa: E501
        """
