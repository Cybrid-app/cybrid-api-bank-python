...
def lazy_import():
    ...
    globals()['DepositAddress'] = DepositAddress


class DepositAddressList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([DepositAddress],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """DepositAddressList - a model defined in OpenAPI
