...
class InternalExecution(ModelNormal):
    ...
    def _from_openapi_data(cls, guid, type, plan_guid, created_at, updated_at, state, source_account, destination_account, stages, fees, travel_rule_info, *args, **kwargs):  # noqa: E501
        """InternalExecution - a model defined in OpenAPI
        ...
        Args:
            ...
            stages ([InternalStage]): The stages of the execution.
            fees ([InternalFeeAssociation]): The fees associated with the execution.
