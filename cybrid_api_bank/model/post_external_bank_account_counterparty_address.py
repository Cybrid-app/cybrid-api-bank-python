...
class PostExternalBankAccountCounterpartyAddress(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostExternalBankAccountCounterpartyAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            street (str, none_type): The first line of the address. Required when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            street2 (str, none_type): The optional second line of the address. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            city (str, none_type): The city of the address. Required when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            subdivision (str, none_type): The ISO 3166-2 subdivision code of the address. Applicable only for countries that use subnational states, provinces, lands, oblasts or regions. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            postal_code (str, none_type): The postal, zip or post code of the address. Applicable only for countries that use postal, zip or post codes. Optional when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
            country_code (str, none_type): The ISO 3166 country 2-Alpha country code of the address. Required when account_kind is raw_routing_details and counterparty_guid is not present.. [optional]  # noqa: E501
        """
