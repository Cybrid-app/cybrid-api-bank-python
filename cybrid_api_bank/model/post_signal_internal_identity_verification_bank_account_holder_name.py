...
class PostSignalInternalIdentityVerificationBankAccountHolderName(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, full, *args, **kwargs):  # noqa: E501
        """PostSignalInternalIdentityVerificationBankAccountHolderName - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, full, *args, **kwargs):  # noqa: E501
        """PostSignalInternalIdentityVerificationBankAccountHolderName - a model defined in OpenAPI
