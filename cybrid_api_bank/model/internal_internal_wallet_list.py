...
def lazy_import():
    ...
    globals()['InternalInternalWallet'] = InternalInternalWallet


class InternalInternalWalletList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalInternalWallet],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalInternalWalletList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalInternalWallet]): Array of internal wallet entities
