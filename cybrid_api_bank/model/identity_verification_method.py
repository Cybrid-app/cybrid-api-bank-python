...
class IdentityVerificationMethod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["business_registration", "id_and_selfie", "tax_id_and_selfie", "attested", "attested_ownership", "account_ownership", "plaid_identity_match", "document_submission", "watchlists", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["business_registration", "id_and_selfie", "tax_id_and_selfie", "attested", "attested_ownership", "account_ownership", "plaid_identity_match", "document_submission", "watchlists", ]  # noqa: E501
