...
class IdentityVerificationMethod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["attested", "document_submission", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_ownership", "account_ownership", "watchlists", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["attested", "document_submission", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_ownership", "account_ownership", "watchlists", ]  # noqa: E501
