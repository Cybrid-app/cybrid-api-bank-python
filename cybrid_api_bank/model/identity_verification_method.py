...
class IdentityVerificationMethod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdentityVerificationMethod - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["attested", "document_submission", "enhanced_due_diligence", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_id_and_selfie", "attested_business_registration", "attested_business_associate", "attested_id_and_database", "watchlists", "attested_ownership", "account_ownership", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["attested", "document_submission", "enhanced_due_diligence", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_id_and_selfie", "attested_business_registration", "attested_business_associate", "attested_id_and_database", "watchlists", "attested_ownership", "account_ownership", ]  # noqa: E501
