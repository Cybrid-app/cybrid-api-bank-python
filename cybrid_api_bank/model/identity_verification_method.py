...
class IdentityVerificationMethod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["attested", "document_submission", "enhanced_due_diligence", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_id_and_selfie", "attested_business_registration", "attested_business_associate", "watchlists", "attested_ownership", "account_ownership", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["attested", "document_submission", "enhanced_due_diligence", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_id_and_selfie", "attested_business_registration", "attested_business_associate", "watchlists", "attested_ownership", "account_ownership", ]  # noqa: E501
