...
class IdentityVerificationMethod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["business_registration", "id_and_selfie", "attested", "plaid_identity_match", "document_submission", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["business_registration", "id_and_selfie", "attested", "plaid_identity_match", "document_submission", ]  # noqa: E501
