...
class ExternalBankAccountState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["storing", "completed", "failed", "refresh_required", "unverified", "deleting", "deleted", "pending", "reviewing", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["storing", "completed", "failed", "refresh_required", "unverified", "deleting", "deleted", "pending", "reviewing", ]  # noqa: E501
