...
class PostInternalWalletService(ModelNormal):
    ...
    def _from_openapi_data(cls, environment, type, name, *args, **kwargs):  # noqa: E501
        """PostInternalWalletService - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            guid (str, none_type): The unique identifier for the wallet service.. [optional]  # noqa: E501
        """
