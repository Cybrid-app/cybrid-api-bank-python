...
class ExternalBankAccountPiiInnerRoutingDetailsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, routing_number_type, routing_number, *args, **kwargs):  # noqa: E501
        """ExternalBankAccountPiiInnerRoutingDetailsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            payment_rail (str, none_type): The payment rail this routing entry is configured for; one of EFT, ACH, RTP, WIRE, SPEI, PIX, COELSA, PSE, ETRANSFER, IFSC, SBP, BEFTN, NGBANK, LBTR, EASY_PAISA, FINJA, JAZZ_CASH, NAYA_PAY, SADA_PAY, KEBANK, MPESA, or UNSPECIFIED. Null for accounts that did not specify a rail.. [optional]  # noqa: E501
        """
