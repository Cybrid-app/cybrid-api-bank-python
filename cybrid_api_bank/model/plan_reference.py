...
class PlanReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, guid, *args, **kwargs):  # noqa: E501
        """PlanReference - a model defined in OpenAPI

        Args:
            type (str): The type of object being referenced; one of returned_execution or returned_stage.
            guid (str): The guid of the referenced object.
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, guid, *args, **kwargs):  # noqa: E501
        """PlanReference - a model defined in OpenAPI
