...
class PatchInternalTransfer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'network_fee': (int,),  # noqa: E501
            'network_fee_liability_amount': (int,),  # noqa: E501
            'network_fee_liability_amount_asset': (str,),  # noqa: E501
            'return_code': (str,),  # noqa: E501
            'returned_at': (str,),  # noqa: E501
            'hold_started_at': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PatchInternalTransfer - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_code (str): The failure code for failed transfers.. [optional]  # noqa: E501
            amount (int): The actual amount in base units of asset.. [optional]  # noqa: E501
            txn_hash (str): The hash of the blockchain transaction. [optional]  # noqa: E501
            network_fee (int): The actual network fee in base units of network_fee_asset. Only present on `crypto` transfers that have successfully completed.. [optional]  # noqa: E501
            network_fee_liability_amount (int): The equivalent fiat network fee in base units of network_fee_liability_amount_asset. Only present on `crypto` transfers that have successfully completed.. [optional]  # noqa: E501
            network_fee_liability_amount_asset (str): The fiat asset the network_fee_liability_amount is denominated in. Only present on `crypto` transfers that have successfully completed.. [optional]  # noqa: E501
            return_code (str): The code for the transfer return.. [optional]  # noqa: E501
            returned_at (str): The ISO8601 datetime when the transfer was returned.. [optional]  # noqa: E501
            hold_started_at (str): The ISO8601 datetime when the transfer entered the hold state.. [optional]  # noqa: E501
            hold_duration (int): The approximate time (in seconds) that the transfer will be held for.. [optional]  # noqa: E501
        """
