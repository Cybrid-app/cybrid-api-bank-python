...
def lazy_import():
    ...
    globals()['InternalWalletService'] = InternalWalletService


class InternalWalletServiceList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalWalletService],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalWalletServiceList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalWalletService]): Array of internal wallet entities
