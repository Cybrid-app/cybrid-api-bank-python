...
class PatchInternalExternalBankAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalExternalBankAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_code (str, none_type): The failure code for failed external bank accounts.. [optional]  # noqa: E501
        """
