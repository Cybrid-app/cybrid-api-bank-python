...
class PostExecution(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sardine_session_guid': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'sardine_session_guid': 'sardine_session_guid',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, plan_guid, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            sardine_session_guid (str, none_type): The GUID of a previously created Sardine session. Used to correlate device signals from the Sardine SDK with the execution screening.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, plan_guid, *args, **kwargs):  # noqa: E501
        """PostExecution - a model defined in OpenAPI
