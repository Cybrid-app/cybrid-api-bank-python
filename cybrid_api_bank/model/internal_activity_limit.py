...
class InternalActivityLimit(ModelNormal):
    ...
    def _from_openapi_data(cls, name, limit_type, limit_asset, limit_amount, *args, **kwargs):  # noqa: E501
        """InternalActivityLimit - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            limit_interval (int, none_type): The interval of the limit.. [optional]  # noqa: E501
        """
