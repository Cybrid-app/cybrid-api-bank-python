...
class PostBankAccountDetails(ModelNormal):
    ...
    def _from_openapi_data(cls, account_identifier, payment_rail, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            account_identifier_type (str, none_type): The type of account identifier. Must be PHONE_NUMBER for mobile wallet rails. Required when payment_rail is EASY_PAISA, payment_rail is FINJA, payment_rail is JAZZ_CASH, payment_rail is NAYA_PAY, payment_rail is SADA_PAY, or payment_rail is MPESA.. [optional]  # noqa: E501
