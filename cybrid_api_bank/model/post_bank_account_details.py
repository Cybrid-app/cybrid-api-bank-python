...
class PostBankAccountDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bank_code_type, account_identifier, payment_rail, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            account_identifier_type (str, none_type): The type of account identifier.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, bank_code_type, account_identifier, payment_rail, *args, **kwargs):  # noqa: E501
        """PostBankAccountDetails - a model defined in OpenAPI
