...
class PostBankAccountDetails(ModelNormal):
    ...
    def _from_openapi_data(cls, account_identifier, payment_rail, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            account_type (str, none_type): The type of account. Required when payment_rail is PSE or payment_rail is LBTR. Optional when payment_rail is ACH.. [optional]  # noqa: E501
