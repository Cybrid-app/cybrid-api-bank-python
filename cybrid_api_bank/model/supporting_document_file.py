...
class SupportingDocumentFile(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, filename, content_type, *args, **kwargs):  # noqa: E501
        """SupportingDocumentFile - a model defined in OpenAPI

        Args:
            guid (str): Auto-generated unique identifier for the file.
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, filename, content_type, *args, **kwargs):  # noqa: E501
        """SupportingDocumentFile - a model defined in OpenAPI
