...
class PostInternalExchangeSettlement(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'automatic': (bool, none_type,),  # noqa: E501
            'trade_guids': ([str], none_type,),  # noqa: E501
            'trades_created_at_lt': (datetime, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'trades_created_at_lt': 'trades_created_at_lt',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, exchange_guid, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeSettlement - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            automatic (bool, none_type): Whether the settlement should be automatic.. [optional] if omitted the server will use the default value of False  # noqa: E501
            trade_guids ([str], none_type): The trade guids to include in the settlement.. [optional]  # noqa: E501
            trades_created_at_lt (datetime, none_type): Include trades created before this timestamp (exclusive).. [optional]  # noqa: E501
            allowed_symbols ([str], none_type): The trading symbols to include in the settlement.. [optional]  # noqa: E501
            denied_symbols ([str], none_type): The trading symbols to exclude from the settlement.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, exchange_guid, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeSettlement - a model defined in OpenAPI
