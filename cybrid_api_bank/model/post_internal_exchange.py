...
class PostInternalExchange(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, provider, environment, *args, **kwargs):  # noqa: E501
        """PostInternalExchange - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            guid (str, none_type): The unique identifier for the exchange.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, provider, environment, *args, **kwargs):  # noqa: E501
        """PostInternalExchange - a model defined in OpenAPI
