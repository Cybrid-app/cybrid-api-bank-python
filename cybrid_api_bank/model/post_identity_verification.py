...
class PostIdentityVerification(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            method (str): The identity verification method.. defaults to "id_and_selfie", must be one of ["id_and_selfie", ]  # noqa: E501
            ...
            country_code (str, none_type): The ISO 3166 country 2-Alpha country the customer is being verified in. If not present, will default to the Bank's configured country code.. [optional]  # noqa: E501
        ...
        method = kwargs.get('method', "id_and_selfie")
