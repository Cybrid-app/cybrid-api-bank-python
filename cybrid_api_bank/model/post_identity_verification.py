...
class PostIdentityVerification(ModelNormal):
    ...
    def _from_openapi_data(cls, type, method, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            date_of_birth (date, none_type): The customer's date of birth; required when method is set to 'attested'.. [optional]  # noqa: E501
            ...
            identification_numbers ([PostIdentificationNumber], none_type): The customer's identification numbers; required when method is set to 'attested'.. [optional]  # noqa: E501
