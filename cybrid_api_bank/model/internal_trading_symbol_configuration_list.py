...
def lazy_import():
    ...
    globals()['InternalTradingSymbolConfiguration'] = InternalTradingSymbolConfiguration


class InternalTradingSymbolConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalTradingSymbolConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalTradingSymbolConfigurationList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalTradingSymbolConfiguration]): Array of entities
