...
def lazy_import():
    ...
    globals()['InternalExternalWallet'] = InternalExternalWallet


class InternalExternalWalletList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExternalWallet],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExternalWalletList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExternalWallet]): Array of external wallet entities
