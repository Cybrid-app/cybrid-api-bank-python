...
class PostInternalCryptoAssetConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, deposits_enabled, asset, *args, **kwargs):  # noqa: E501
        """PostInternalCryptoAssetConfiguration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            maximum_number_of_addresses (int, none_type): The maximum number of deposit addresses allowed for the asset on the platform. Must be omitted or set to nil if deposits_enabled is False.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, deposits_enabled, asset, *args, **kwargs):  # noqa: E501
        """PostInternalCryptoAssetConfiguration - a model defined in OpenAPI
