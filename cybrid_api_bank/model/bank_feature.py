...
class BankFeature(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'BUSINESS_CUSTOMER_RAW_ROUTING_DETAILS': "business_customer_raw_routing_details",
            'INDIVIDUAL_CUSTOMER_RAW_ROUTING_DETAILS': "individual_customer_raw_routing_details",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """BankFeature - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["kyc_identity_verifications", "attestation_identity_records", "attestation_identity_records_v2", "raw_routing_details", "individual_customers", "business_customers", "counterparty_external_accounts", "business_customer_raw_routing_details", "individual_customer_raw_routing_details", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["kyc_identity_verifications", "attestation_identity_records", "attestation_identity_records_v2", "raw_routing_details", "individual_customers", "business_customers", "counterparty_external_accounts", "business_customer_raw_routing_details", "individual_customer_raw_routing_details", ]  # noqa: E501
