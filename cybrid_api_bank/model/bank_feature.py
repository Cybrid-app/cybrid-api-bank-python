...
class BankFeature(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'DESTINATION_PARTICIPANT_CORRECTIONS': "destination_participant_corrections",
        },
    }
