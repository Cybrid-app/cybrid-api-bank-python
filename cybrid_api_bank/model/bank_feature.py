...
class BankFeature(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["kyc_identity_verifications", "attestation_identity_records", "attestation_identity_records_v2", "raw_routing_details", "individual_customers", "business_customers", "counterparty_external_accounts", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["kyc_identity_verifications", "attestation_identity_records", "attestation_identity_records_v2", "raw_routing_details", "individual_customers", "business_customers", "counterparty_external_accounts", ]  # noqa: E501
