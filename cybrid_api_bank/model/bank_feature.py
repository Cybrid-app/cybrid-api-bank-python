...
class BankFeature(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["attestation_identity_records", "kyc_identity_verifications", "raw_routing_details", "individual_customers", "business_customers", "accessible_identification_numbers", "counterparty_external_accounts", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["attestation_identity_records", "kyc_identity_verifications", "raw_routing_details", "individual_customers", "business_customers", "accessible_identification_numbers", "counterparty_external_accounts", ]  # noqa: E501
