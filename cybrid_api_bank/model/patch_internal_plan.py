...
class PatchInternalPlan(ModelNormal):
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """PatchInternalPlan - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            accounts ([PatchInternalAccountAssociation], none_type): The accounts with quoted amounts.. [optional]  # noqa: E501
        """
