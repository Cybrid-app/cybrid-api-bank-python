...
class InternalPostDepositBankAccount(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'unique_memo_id': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, account_guid, *args, **kwargs):  # noqa: E501
        """InternalPostDepositBankAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            parent_deposit_bank_account_guid (str, none_type): The unique identifier for the bank-level deposit bank account. This is only required for sub-accounts.. [optional]  # noqa: E501
            provider_id (str, none_type): Optional provider_id to use for the account.  Can only be set in Sandbox mode. It is automatically set in Production. Strictly for testing purposes.. [optional]  # noqa: E501
            unique_memo_id (str, none_type): Optional unique_memo_id to use for the account.  Can only be set in Sandbox mode. It is automatically set in Production. Strictly for testing purposes.. [optional]  # noqa: E501
