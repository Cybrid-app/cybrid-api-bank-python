...
class PostInternalInternalWalletRoutingDetail(ModelNormal):
    ...
    allowed_values = {
        ('route_type',): {
            ...
            'CIRCLE_RECIPIENT_ADDRESS': "circle_recipient_address",
            'STRIKE_RECIPIENT_ADDRESS': "strike_recipient_address",
            'BITGO_RECIPIENT_ADDRESS': "bitgo_recipient_address",
            'FALCONX_WHITELISTED_ADDRESS': "falconx_whitelisted_address",
            'AQUANOW_RECIPIENT_ADDRESS': "aquanow_recipient_address",
            'BITSO_DESTINATION_ADDRESS': "bitso_destination_address",
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, route_type, provider_id, wallet_service_guid, *args, **kwargs):  # noqa: E501
        """PostInternalInternalWalletRoutingDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, route_type, provider_id, wallet_service_guid, *args, **kwargs):  # noqa: E501
        """PostInternalInternalWalletRoutingDetail - a model defined in OpenAPI
