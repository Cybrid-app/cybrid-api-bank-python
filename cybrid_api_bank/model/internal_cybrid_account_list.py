...
def lazy_import():
    ...
    globals()['InternalCybridAccount'] = InternalCybridAccount


class InternalCybridAccountList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalCybridAccount],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalCybridAccountList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalCybridAccount]): Array of internal Cybrid account entities
