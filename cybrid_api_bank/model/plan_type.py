...
class PlanType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlanType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["remittance", "bill_pay", "disbursement", "invoice_pay", "deposit", "withdrawal", "conversion", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["remittance", "bill_pay", "disbursement", "invoice_pay", "deposit", "withdrawal", "conversion", ]  # noqa: E501
