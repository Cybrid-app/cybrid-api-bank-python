...
class PostFee(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'spread_fee': (int, none_type,),  # noqa: E501
            'fixed_fee': (int, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """PostFee - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            spread_fee (int, none_type): The percentage amount, in basis points, to apply when charging a fee. Required when type is spread.. [optional]  # noqa: E501
            fixed_fee (int, none_type): The fixed amount to apply when charging a fee; for trades, the fiat asset is used. Required when type is fixed.. [optional]  # noqa: E501
        """
