...
class TransferFailureCode(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'RETURN_RISK_EXCEEDED': "return_risk_exceeded",
            'DAILY_LIMIT_EXCEEDED': "daily_limit_exceeded",
            'WEEKLY_LIMIT_EXCEEDED': "weekly_limit_exceeded",
            'MONTHLY_LIMIT_EXCEEDED': "monthly_limit_exceeded",
            'CUSTOMER_CONTACT_INFO_MISSING': "customer_contact_info_missing",
