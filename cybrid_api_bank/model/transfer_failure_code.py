...
class TransferFailureCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TransferFailureCode - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["non_sufficient_funds", "refresh_required", "party_name_invalid", "payment_rail_invalid", "compliance_rejection", "cancelled", "reversed", "limit_exceeded", "network_fee_too_low", "amount_too_low", "internal_error", "invalid_address", "invalid_destination", "customer_action_required", "external_vendor_error", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["non_sufficient_funds", "refresh_required", "party_name_invalid", "payment_rail_invalid", "compliance_rejection", "cancelled", "reversed", "limit_exceeded", "network_fee_too_low", "amount_too_low", "internal_error", "invalid_address", "invalid_destination", "customer_action_required", "external_vendor_error", ]  # noqa: E501
