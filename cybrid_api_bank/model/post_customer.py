...
def lazy_import():
    ...
    globals()['PostCustomerAddress'] = PostCustomerAddress
    globals()['PostCustomerAliasesInner'] = PostCustomerAliasesInner
    globals()['PostCustomerName'] = PostCustomerName
    globals()['PostIdentificationNumber'] = PostIdentificationNumber


class PostCustomer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'address': (PostCustomerAddress,),  # noqa: E501
            'phone_number': (str, none_type,),  # noqa: E501
            'email_address': (str, none_type,),  # noqa: E501
            'identification_numbers': ([PostIdentificationNumber], none_type,),  # noqa: E501
            'name': (PostCustomerName,),  # noqa: E501
            'date_of_birth': (date, none_type,),  # noqa: E501
            'aliases': ([PostCustomerAliasesInner], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'identification_numbers': 'identification_numbers',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """PostCustomer - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            address (PostCustomerAddress): [optional]  # noqa: E501
            phone_number (str, none_type): The customer's phone number.. [optional]  # noqa: E501
            email_address (str, none_type): The customer's email address.. [optional]  # noqa: E501
            identification_numbers ([PostIdentificationNumber], none_type): The customer's identification numbers.. [optional]  # noqa: E501
            name (PostCustomerName): [optional]  # noqa: E501
            date_of_birth (date, none_type): The customer's date of birth. Optional when type is individual.. [optional]  # noqa: E501
            aliases ([PostCustomerAliasesInner], none_type): The aliases of the customer. Optional when type is business.. [optional]  # noqa: E501
            website (str, none_type): The customer's website. Optional when type is business.. [optional]  # noqa: E501
            labels ([str], none_type): The labels associated with the customer.. [optional]  # noqa: E501
        """
