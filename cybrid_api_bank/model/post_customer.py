...
class PostCustomer(ModelNormal):
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            phone_number (str, none_type): The customer's phone number. Optional when type is individual.. [optional]  # noqa: E501
            email_address (str, none_type): The customer's email address. Optional when type is individual.. [optional]  # noqa: E501
            identification_numbers ([PostIdentificationNumber], none_type): The customer's identification numbers. Optional when type is individual.. [optional]  # noqa: E501
