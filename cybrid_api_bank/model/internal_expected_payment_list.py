...
def lazy_import():
    ...
    globals()['InternalExpectedPayment'] = InternalExpectedPayment


class InternalExpectedPaymentList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExpectedPayment],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExpectedPaymentList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExpectedPayment]): Array of payment entities
