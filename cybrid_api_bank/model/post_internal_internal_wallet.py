...
def lazy_import():
    ...
    globals()['PostInternalInternalWalletRoutingDetail'] = PostInternalInternalWalletRoutingDetail


class PostInternalInternalWallet(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'routing_details': ([PostInternalInternalWalletRoutingDetail], none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, name, asset, account_kind, environment, *args, **kwargs):  # noqa: E501
        """PostInternalInternalWallet - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            provider_id (str): The id of the account at the third-party provider.. [optional]  # noqa: E501
            wallet_service_guid (str): The wallet service guid; required when specifying the provider_id.. [optional]  # noqa: E501
            internal_wallet_group_guid (str): The unique identifier of the wallet group.. [optional]  # noqa: E501
            bank_guid (str, none_type): The unique identifier for the bank associated with the trading deposits wallet.. [optional]  # noqa: E501
            customer_guid (str, none_type): The unique identifier for the customer associated with the trading deposits wallet.. [optional]  # noqa: E501
            routing_details ([PostInternalInternalWalletRoutingDetail], none_type): The routing details for this wallet.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, name, asset, account_kind, environment, *args, **kwargs):  # noqa: E501
        """PostInternalInternalWallet - a model defined in OpenAPI
