...
def lazy_import():
    ...
    globals()['InternalFeeCharge'] = InternalFeeCharge


class InternalFeeChargeList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalFeeCharge],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalFeeChargeList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalFeeCharge]): Array of entities
