...
def lazy_import():
    ...
    globals()['InternalCryptoAssetConfiguration'] = InternalCryptoAssetConfiguration


class InternalCryptoAssetConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalCryptoAssetConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalCryptoAssetConfigurationList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalCryptoAssetConfiguration]): Array of entities
