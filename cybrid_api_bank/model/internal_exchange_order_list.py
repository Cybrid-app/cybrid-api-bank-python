...
def lazy_import():
    ...
    globals()['InternalExchangeOrder'] = InternalExchangeOrder


class InternalExchangeOrderList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExchangeOrder],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExchangeOrderList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExchangeOrder]): Array of entities
