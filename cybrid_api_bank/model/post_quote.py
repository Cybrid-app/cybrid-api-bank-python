...
class PostQuote(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'product_provider': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, customer_guid, side, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            symbol (str): Symbol the quote is being requested for. Format is \"asset-counter_asset\" in uppercase. See the Symbols API for a complete list of cryptocurrencies supported.. [optional]  # noqa: E501
            asset (str): The asset code the quote was requested for. Populated for savings quotes.. [optional]  # noqa: E501
            ...
            product_provider (str): The provider for the product being quoted. Populated for savings quotes.. [optional] if omitted the server will use the default value of "compound"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, customer_guid, side, *args, **kwargs):  # noqa: E501
        """PostQuote - a model defined in OpenAPI
