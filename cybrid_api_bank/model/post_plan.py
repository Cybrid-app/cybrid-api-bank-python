...
def lazy_import():
    ...
    from cybrid_api_bank.model.post_plan_intermediate_accounts_inner import PostPlanIntermediateAccountsInner
    ...
    globals()['PostPlanIntermediateAccountsInner'] = PostPlanIntermediateAccountsInner
    globals()['PostPlanSourceAccount'] = PostPlanSourceAccount
    globals()['PostPlanTravelRuleInfo'] = PostPlanTravelRuleInfo
    globals()['PostSupportingDocument'] = PostSupportingDocument
...
class PostPlan(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'intermediate_accounts': ([PostPlanIntermediateAccountsInner], none_type,),  # noqa: E501
            ...
            'supporting_documents': ([PostSupportingDocument], none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, source_account, destination_account, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            intermediate_accounts ([PostPlanIntermediateAccountsInner], none_type): Accounts to disambiguate a multi-stage plan when more than one account of the same asset is eligible for a stage.. [optional]  # noqa: E501
            ...
            supporting_documents ([PostSupportingDocument], none_type): Supporting documents to attach to the plan. Optional when type is remittance or type is invoice_pay.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, source_account, destination_account, *args, **kwargs):  # noqa: E501
        """PostPlan - a model defined in OpenAPI
