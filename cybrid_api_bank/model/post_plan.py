...
class PostPlan(ModelNormal):
    ...
    def _from_openapi_data(cls, source_account, destination_account, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            supporting_documents ([PostSupportingDocument], none_type): Supporting documents to attach to the plan. Only valid for remittance plans; requests that include this field on other plan types are rejected. Optional when type is remittance.. [optional]  # noqa: E501
        """
