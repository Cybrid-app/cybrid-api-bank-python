...
class TransferState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["storing", "pending", "reviewing", "completed", "failed", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["storing", "pending", "reviewing", "completed", "failed", ]  # noqa: E501
