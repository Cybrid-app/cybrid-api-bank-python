...
class PostPlanSourceAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, guid, *args, **kwargs):  # noqa: E501
        """PostPlanSourceAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            payment_rail (str, none_type): The desired payment rail to use to initiate a fiat transfer from the source account.. [optional]  # noqa: E501
        """
