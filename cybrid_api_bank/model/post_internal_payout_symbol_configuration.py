...
class PostInternalPayoutSymbolConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, enabled, symbol, country_code, participants_type, route, *args, **kwargs):  # noqa: E501
        """PostInternalPayoutSymbolConfiguration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, enabled, symbol, country_code, participants_type, route, *args, **kwargs):  # noqa: E501
        """PostInternalPayoutSymbolConfiguration - a model defined in OpenAPI
