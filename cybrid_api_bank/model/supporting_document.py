...
class SupportingDocument(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, files, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): The kind of supporting document; one of invoice.. defaults to "invoice", must be one of ["invoice", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, files, *args, **kwargs):  # noqa: E501
        """SupportingDocument - a model defined in OpenAPI
