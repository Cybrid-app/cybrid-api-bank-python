...
def lazy_import():
    ...
    globals()['SupportingDocumentFile'] = SupportingDocumentFile


class SupportingDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'guid': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'files': ([SupportingDocumentFile],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, type, files, *args, **kwargs):  # noqa: E501
        """SupportingDocument - a model defined in OpenAPI
        ...
        Args:
            ...
            files ([SupportingDocumentFile]): The files backing this document.
        ...
        Keyword Args:
            ...
            document_reference_number (str, none_type): A reference number identifying this document (e.g. an invoice number).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, type, files, *args, **kwargs):  # noqa: E501
        """SupportingDocument - a model defined in OpenAPI
