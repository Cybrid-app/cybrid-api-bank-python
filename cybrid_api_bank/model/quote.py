"""
    ...
    The version of the OpenAPI document: v0.37.28
...
class Quote(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            asset (str, none_type): The asset code the quote was requested for. Populated for savings quotes.. [optional]  # noqa: E501
            side (str): The direction of the quote: either 'buy' or 'sell' for trade quotes; 'deposit' or 'withdrawal' for savings quotes.. [optional]  # noqa: E501
            receive_amount (int): The amount to be received in base units of the currency: currency is \"asset\" for buy and \"counter_asset\" for sell for trade quotes and currency is always \"asset\" for savings quotes.. [optional]  # noqa: E501
            deliver_amount (int): The amount to be delivered in base units of the currency: currency is \"counter_asset\" for buy and \"asset\" for sell for trade quotes and currency is always \"asset\" for savings quotes.. [optional]  # noqa: E501
            fee (int): The fee associated with the trade. Denominated in \"counter_asset\" base units for trade quotes and \"asset\" for savings quotes.. [optional]  # noqa: E501
            ...
            product_provider (str, none_type): The provider for the product being quoted. Populated for savings quotes.. [optional] if omitted the server will use the default value of "compound"  # noqa: E501
        """
