...
class InternalBusinessDetail(ModelNormal):
    ...
    attribute_map = {
        ...
        'business_guid': 'business_guid',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, created_at, business_guid, revision, state, *args, **kwargs):  # noqa: E501
        """InternalBusinessDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, created_at, business_guid, revision, state, *args, **kwargs):  # noqa: E501
        """InternalBusinessDetail - a model defined in OpenAPI
