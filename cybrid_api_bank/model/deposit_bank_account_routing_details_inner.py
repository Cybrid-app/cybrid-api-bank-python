...
class DepositBankAccountRoutingDetailsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, routing_number_type, routing_number, *args, **kwargs):  # noqa: E501
        """DepositBankAccountRoutingDetailsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, routing_number_type, routing_number, *args, **kwargs):  # noqa: E501
        """DepositBankAccountRoutingDetailsInner - a model defined in OpenAPI
