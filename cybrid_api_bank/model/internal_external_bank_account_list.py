...
def lazy_import():
    ...
    globals()['InternalExternalBankAccount'] = InternalExternalBankAccount


class InternalExternalBankAccountList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExternalBankAccount],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExternalBankAccountList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExternalBankAccount]): Array of external bank account entities
