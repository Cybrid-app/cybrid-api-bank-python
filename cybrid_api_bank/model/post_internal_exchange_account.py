...
class PostInternalExchangeAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, exchange_guid, asset, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeAccount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, exchange_guid, asset, *args, **kwargs):  # noqa: E501
        """PostInternalExchangeAccount - a model defined in OpenAPI
