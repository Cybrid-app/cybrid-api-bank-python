...
class ListRequestOwner(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListRequestOwner - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The owner of the entity.., must be one of ["bank", "customer", ]  # noqa: E501

        Keyword Args:
            value (str): The owner of the entity.., must be one of ["bank", "customer", ]  # noqa: E501
