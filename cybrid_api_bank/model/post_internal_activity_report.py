...
class PostInternalActivityReport(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            ...
            'CRYPTO': "crypto",
            'FUNDING': "funding",
            'TRADE_PRIMARY_ASSET': "trade_primary_asset",
            'TRADE_COUNTER_ASSET': "trade_counter_asset",
        },
        ('environment',): {
            'SANDBOX': "sandbox",
    ...
    attribute_map = {
        ...
        'exclude_guids': 'exclude_guids',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, environment, customer_guid, asset, start_time, end_time, *args, **kwargs):  # noqa: E501
        """PostInternalActivityReport - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            exclude_guids ([str]): The list of guids to exclude from the report.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, environment, customer_guid, asset, start_time, end_time, *args, **kwargs):  # noqa: E501
        """PostInternalActivityReport - a model defined in OpenAPI
