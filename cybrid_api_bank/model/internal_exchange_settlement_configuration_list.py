...
def lazy_import():
    ...
    globals()['InternalExchangeSettlementConfiguration'] = InternalExchangeSettlementConfiguration


class InternalExchangeSettlementConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExchangeSettlementConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExchangeSettlementConfigurationList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExchangeSettlementConfiguration]): Array of entities
