...
class PostSignalInternalIdentityVerificationBankAccountHolderAddress(ModelNormal):
    ...
    def _from_openapi_data(cls, street, city, country_code, *args, **kwargs):  # noqa: E501
        """PostSignalInternalIdentityVerificationBankAccountHolderAddress - a model defined in OpenAPI
