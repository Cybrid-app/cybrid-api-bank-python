...
def lazy_import():
    ...
    globals()['DepositBankAccount'] = DepositBankAccount


class DepositBankAccountList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([DepositBankAccount],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """DepositBankAccountList - a model defined in OpenAPI
