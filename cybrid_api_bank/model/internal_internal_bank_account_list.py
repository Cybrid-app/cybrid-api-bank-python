...
def lazy_import():
    ...
    globals()['InternalInternalBankAccount'] = InternalInternalBankAccount


class InternalInternalBankAccountList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalInternalBankAccount],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalInternalBankAccountList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalInternalBankAccount]): Array of internal bank account entities
