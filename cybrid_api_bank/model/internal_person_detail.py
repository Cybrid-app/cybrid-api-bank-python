...
class InternalPersonDetail(ModelNormal):
    ...
    attribute_map = {
        ...
        'person_guid': 'person_guid',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, created_at, updated_at, person_guid, revision, state, *args, **kwargs):  # noqa: E501
        """InternalPersonDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, created_at, updated_at, person_guid, revision, state, *args, **kwargs):  # noqa: E501
        """InternalPersonDetail - a model defined in OpenAPI
