...
def lazy_import():
    ...
    globals()['InternalExchange'] = InternalExchange


class InternalExchangeList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExchange],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExchangeList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExchange]): Array of exchange entities
