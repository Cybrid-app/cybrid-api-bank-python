...
def lazy_import():
    ...
    globals()['InternalExchangeSettlementPaymentOrder'] = InternalExchangeSettlementPaymentOrder


class InternalExchangeSettlementPaymentOrderList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([InternalExchangeSettlementPaymentOrder],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """InternalExchangeSettlementPaymentOrderList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([InternalExchangeSettlementPaymentOrder]): Array of payment entities
