...
from cybrid_api_bank.api.assets_bank_api import AssetsBankApi  # noqa: E501


class TestAssetsBankApi(unittest.TestCase):
    """AssetsBankApi unit test stubs"""

    def setUp(self):
        self.api = AssetsBankApi()  # noqa: E501
