...
from cybrid_api_bank.api.accounts_bank_api import AccountsBankApi  # noqa: E501


class TestAccountsBankApi(unittest.TestCase):
    """AccountsBankApi unit test stubs"""

    def setUp(self):
        self.api = AccountsBankApi()  # noqa: E501
